...
window.NM_STAGES = [
  ...
  },
  {
    ...
    tiers:['middle1','middle2','middle3'], courses:{from:29,to:37}, weeks:110,
    learn:{
    ...
    meta:{ko:'과정 29~37 · 주 2회 기준 77주(주 1회 110주) · 실험실 2',en:'Courses 29–37 · 77 weeks at two sheets a week (110 at one) · 2 labs',zh:'课程29~37 · 每周2次约77周(每周1次110周) · 2个实验室'}
  },
  {
