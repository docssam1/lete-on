...
window.NM_UNITS['M-86']={
  ...
  discover:{
    ...
    stages:[
      ...
      {tag:{ko:'② 상자그림',en:'2) Box plot',zh:'② 箱形图'},head:{ko:'상자 Q1~Q3 · 선 Q2 · 수염 양끝',en:'box Q1–Q3 · line Q2 · whiskers to ends',zh:'箱体Q1~Q3·中线Q2·须到两端'},desc:{ko:'Q1과 Q3로 상자를 그리고 Q2에 선을 긋습니다. 상자에서 최솟값과 최댓값까지 수염을 잇습니다.',en:'Draw the box from Q1 to Q3, a median line at Q2, and whiskers to the minimum and maximum.',zh:'从Q1到Q3画箱体，在Q2画中线，再连接到最小值与最大值。'},mathSteps:[{ko:'\\text{최솟값},\\;Q_1,\\;Q_2,\\;Q_3,\\;\\text{최댓값}',en:'\\text{min},\\;Q_1,\\;Q_2,\\;Q_3,\\;\\text{max}',zh:'\\text{最小值},\\;Q_1,\\;Q_2,\\;Q_3,\\;\\text{最大值}'}],result:{ko:'위치는 반드시 눈금에 맞춤',en:'Every mark must align to the scale',zh:'每个位置必须对准刻度'},book:{ko:'상자그림에서 평균이나 자료의 개별 개수는 읽을 수 없습니다.',en:'A box plot does not reveal the mean or each exact frequency.',zh:'箱形图不能读出平均数或各个数值的准确频数。'}}
    ],
