...
window.NM_UNITS['M-47'] = {
  id:'M-47', tier:'middle1', level:'29', order:5,
  generator:'md47_expressionNotation',
  title:{ ko:'문자식 표현', en:'Algebraic Expression Notation', zh:'代数式的表示' },
  subtitle:{ ko:'곱셈 기호를 지우고, 나눗셈을 분수로 바꿉니다', en:'Drop the multiplication sign, turn division into a fraction', zh:'省略乘号，把除法变成分数' },
  icon:'🔤',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'사탕 가게에서 사탕 한 개의 가격을 모를 때, 우리는 그 가격을 a원이라고 문자로 이름 붙입니다. 사탕을 3개 사면 얼마일까요? "a×3"이라고 쓸 수도 있지만, 수학자들은 훨씬 짧게 쓰는 약속을 만들었습니다.',
      ...
      history:{ ko:'문자를 수 대신 쓰는 방법은 16세기 프랑스 수학자 비에트가 널리 퍼뜨렸습니다. 곱셈 기호를 생략하는 관습은 그 뒤로 점점 자리 잡아, 지금은 전 세계 수학자가 똑같은 방식으로 문자식을 씁니다.',
    ...
    stages:[
      { tag:{ko:'① × 기호는 지우고, 숫자는 앞으로',en:'1) Drop ×, put the number first',zh:'① 省略×，数字放前面'},
        ...
        desc:{ko:'"a×3"과 "3×a"는 같은 값이지만, 문자식에서는 <b>숫자를 문자 앞</b>에 쓰기로 약속합니다. 그리고 곱셈 기호 ×는 아예 생략합니다 — 그래서 "a×3"은 "3a"가 됩니다.',
        ...
        book:{ko:'계수가 1이면(1×a) 숫자 1도 생략해서 그냥 "a"라고만 씁니다.',
      ...
      { tag:{ko:'② 같은 문자의 반복은 지수로',en:'2) A repeated letter becomes an exponent',zh:'② 同一字母重复就写成指数'},
        ...
        desc:{ko:'같은 문자를 여러 번 곱하면 <b>지수</b>로 몇 번 곱했는지 나타냅니다. x를 3번 곱한 건 x³입니다. 나눗셈은 분수로 바꿔 씁니다 — "a÷4"는 "a/4"가 됩니다.',
        ...
        book:{ko:'"−1×x"는 "−x"로 쓰고, 숫자 1은 생략하지만 부호(−)는 남깁니다.',
  ...
  check:{
    fills:[
      ...
      { tex:'x \\times x = x^{\\square}', answer:2,
        hint:{ ko:'x를 2번 곱했습니다', en:'x is multiplied twice', zh:'x连乘了2次' } }
    ],
    open:{ ko:'b×7÷2를 문자식 표기 규칙에 맞게 정리해봅니다.',
  ...
  arena:{
    ...
    params:{mode:'twoVars'},
    rule:{ ko:'5분 안에 문자가 두 개인 식도 빠르게 정리합니다!', en:'Simplify expressions with two letters quickly, all within 5 minutes!', zh:'5分钟内快速整理含两个字母的式子！' }
  },
  ...
  voice:{
    ...
    wrong:[ {ko:'숫자는 문자 앞으로, ×는 지웁니다!',en:'Numbers go before letters, and drop the ×!',zh:'数字放到字母前面，省略×！'}, {ko:'같은 문자가 반복되면 지수로 씁니다!',en:'A repeated letter becomes an exponent!',zh:'重复的字母写成指数！'} ],
