  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 소수 부분을 먼저 빼요', en:'1) Subtract the decimal part first', zh:'① 先减小数部分' },
        ...
        mathSteps:['3.7 - 1.4 = □',{ko:'소수: 0.7 - 0.4 = 0.3',en:'\\text{decimal parts: } 0.7 - 0.4 = 0.3',zh:'小数部分：0.7 - 0.4 = 0.3'},{ko:'정수: 3 - 1 = 2',en:'\\text{whole parts: } 3 - 1 = 2',zh:'整数部分：3 - 1 = 2'},'2 + 0.3 = 2.3'],
      ...
      { tag:{ ko:'② 받아내림이 있을 때', en:'2) When borrowing is needed', zh:'② 需要借位时' },
        ...
        desc:{ ko:'4.2-1.7=? 소수: 0.2-0.7 불가 → <b>정수에서 1 빌려서</b> 1.2-0.7=0.5. 정수: 4-1-1=2. 답: 2.5!',
        ...
        mathSteps:['4.2 - 1.7 = □',{ko:'소수: 0.2-0.7 → 정수에서 1 빌림',en:'\\text{decimals: } 0.2-0.7 → \\text{borrow 1 from the wholes}',zh:'小数部分：0.2-0.7 → 向整数借1'},'(10+2)-7 = 5 → 0.5',{ko:'정수: 4-1-1 = 2 → 2.5',en:'\\text{wholes: } 4-1-1 = 2 → 2.5',zh:'整数部分：4-1-1 = 2 → 2.5'}],
