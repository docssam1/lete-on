...
window.NM_UNITS['M-49'] = {
  id:'M-49', tier:'middle1', level:'30', order:10,
  generator:'md49_linearExprOps',
  title:{ ko:'일차식의 계산', en:'Linear Expression Operations', zh:'一次式的运算' },
  subtitle:{ ko:'괄호를 풀고, 동류항끼리 더합니다', en:'Expand the parentheses, then combine like terms', zh:'展开括号，合并同类项' },
  icon:'📎',
  ...
  practice:{
    ...
    intro:{
      ko:'괄호 앞의 수는 괄호 안 모든 항에 하나씩 곱합니다(분배법칙) — 한 항이라도 빠뜨리면 안 됩니다!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'상자 안에 여러 물건이 들어 있을 때, 상자 앞의 숫자는 상자 "안의 모든 것"에 곱해집니다. 3(2x+5)는 상자 안의 2x와 5 둘 다에 3을 곱하라는 뜻입니다.',
      ...
      history:{ ko:'분배법칙(a(b+c)=ab+ac)은 고대 바빌로니아·이집트 사람들도 넓이를 나눠 계산할 때 무의식중에 쓰던 원리입니다. 유클리드가 기원전 3세기 『원론』에서 처음 도형으로 증명했습니다.',
    ...
    stages:[
      { tag:{ko:'① 분배법칙 — 괄호 안 모든 항에 곱합니다',en:'1) The distributive law — multiply every term inside',zh:'① 分配律——乘到括号内每一项'},
        head:{ko:'3(2x+5) = 6x+15',en:'3(2x+5) = 6x+15',zh:'3(2x+5) = 6x+15'},
        desc:{ko:'괄호 앞의 3은 괄호 안의 <b>2x와 5 둘 다</b>에 곱해집니다. 3×2x=6x, 3×5=15 — 두 계산을 각각 하고 더하면 6x+15가 나옵니다.',
        ...
        result:{ko:'괄호 앞의 수는 안의 모든 항에 하나씩 곱합니다!',en:'The number in front multiplies every term inside, one by one!',zh:'括号前的数分别乘到里面每一项！'},
      ...
      { tag:{ko:'② 동류항끼리만 더하거나 뺍니다',en:'2) Add or subtract only like terms',zh:'② 只把同类项相加减'},
        head:{ko:'(2x+5)+(3x-1) = 5x+4',en:'(2x+5)+(3x-1) = 5x+4',zh:'(2x+5)+(3x-1) = 5x+4'},
        desc:{ko:'문자와 차수가 같은 항(<b>동류항</b>)끼리만 더하거나 뺍니다. 2x와 3x는 동류항이라 더하면 5x, 5와 −1도 동류항(상수항)이라 더하면 4입니다.',
        ...
        result:{ko:'문자와 차수가 같은 항끼리만 더하거나 뺍니다!',en:'Combine only terms with matching letters and degrees!',zh:'只合并文字和次数都相同的项！'},
        book:{ko:'x항과 상수항은 절대 서로 더할 수 없습니다 — 종류가 다른 항이기 때문입니다.',
              en:'An x-term and a constant term can never be added together — they\'re different kinds of terms.',
              zh:'x项和常数项绝不能相加——它们是不同种类的项。'} }
    ],
    rule:{ ko:'괄호는 분배법칙으로 풀고(모든 항에 곱하기), 그다음 동류항(문자·차수가 같은 항)끼리만 더하거나 뺍니다!',
  ...
  check:{
    ...
    open:{ ko:'2(x+3)−(x+1)을 분배법칙과 동류항 정리 순서로 설명해봅니다.',
  ...
  lab:{
    ...
    params:{mode:'addSub'},
    intro:{
      ko:'동류항끼리만 더하거나 뺍니다 — x항은 x항끼리, 상수항은 상수항끼리!',
  ...
  arena:{
    ...
    params:{mode:'mixed'},
    rule:{ ko:'5분 안에 분배법칙과 동류항 정리를 한 번에 해냅니다!', en:'Distribute and combine like terms all in one go, within 5 minutes!', zh:'5分钟内一次完成分配律和合并同类项！' }
  },
