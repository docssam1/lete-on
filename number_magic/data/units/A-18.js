  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 백의 자리부터 더해요', en:'1) Start with the hundreds', zh:'① 先加百位' },
        ...
        desc:{ ko:'357+468: 먼저 300+400=700. 그 다음 50+60=110을 더해 810. 마지막에 7+8=15을 더해 825!',
               en:'357+468: First 300+400=700. Then add 50+60=110 to get 810. Finally add 7+8=15 to get 825!',
               zh:'357+468：先算300+400=700。再加50+60=110得810。最后加7+8=15得825！' },
      ...
      { tag:{ ko:'② 왜 앞부터 더할까요?', en:'2) Why add from the front?', zh:'② 为什么从前往后加？' },
        ...
        desc:{ ko:'백의 자리를 먼저 더하면 "대략 700쯤 되겠구나"라는 걸 즉시 알 수 있어요. 이걸 누적해 나가면 정확한 답이 나와요.',
               en:'Adding hundreds first instantly tells you "it\'s around 700". Keep accumulating to get the exact answer.',
               zh:'先加百位，就立刻知道"大约700左右"。继续累加就能得到精确答案。' },
