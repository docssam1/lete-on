...
window.NM_UNITS['M-56'] = {
  ...
  subtitle:{ ko:'두 변과 낀각으로 나머지 한 변을 구합니다', en:'Find the third side from two sides and the included angle', zh:'用两边及夹角求第三边' },
  icon:'📐',
  ...
  practice:{
    ...
    params:{mode:'right'},
    intro:{
      ko:'코사인법칙 a²=b²+c²-2bc·cosA — cos90°=0이면 마지막 항이 사라져서 피타고라스 정리와 똑같아집니다!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'피타고라스 정리(a²=b²+c²)는 직각(90°)일 때만 쓸 수 있습니다. 그런데 각이 90°가 아니라면 어떻게 할까요? 코사인법칙은 피타고라스 정리를 어떤 각에서도 쓸 수 있게 "확장"한 공식입니다.',
      ...
      history:{ ko:'코사인법칙의 원형은 유클리드의 『원론』(기원전 3세기)에 도형으로 이미 나와 있었습니다. 지금과 같은 대수식 형태로 정리된 건 16세기 프랑스 수학자 비에트입니다.',
    ...
    stages:[
      { tag:{ko:'① cos90°=0이면 피타고라스 정리와 같습니다',en:'1) With cos90°=0, it\'s the same as the Pythagorean theorem',zh:'① cos90°=0时就和勾股定理相同'},
        ...
        result:{ko:'A=90°이면 코사인법칙이 피타고라스 정리로 그대로 돌아갑니다!',en:'When A=90°, the law of cosines reduces exactly to the Pythagorean theorem!',zh:'A=90°时，余弦定理直接变回勾股定理！'},
        book:{ko:'a²이 나오면 마지막에 반드시 제곱근을 취해야 진짜 변의 길이 a가 나옵니다.',
              en:'Once you get a², you must take the square root at the end to get the actual side length a.',
              zh:'求出a²后一定要开平方才能得到真正的边长a。'} },

      { tag:{ko:'② cos60°=1/2이면 항이 그대로 남습니다',en:'2) With cos60°=1/2, the term stays',zh:'② cos60°=1/2时那一项会留下来'},
        ...
        result:{ko:'cos60°=1/2이면 −2bc·cosA는 −bc로 간단해집니다!',en:'When cos60°=1/2, the term −2bc·cosA simplifies to −bc!',zh:'cos60°=1/2时，−2bc·cosA化简为−bc！'},
        book:{ko:'A=120°(cos=−1/2)이면 부호가 반대가 되어 −2bc×(−1/2)=+bc가 됩니다 — 세 변이 모두 더 길게 벌어지는 둔각 삼각형입니다.',
    ...
    rule:{ ko:'코사인법칙 a²=b²+c²-2bc·cosA — cos90°=0(사라짐), cos60°=1/2(−bc), cos120°=−1/2(+bc)로 딱 떨어지는 각만 다룹니다!',
  ...
  check:{
    ...
    open:{ ko:'b=6, c=10, A=120°일 때 a를 구하는 과정을 설명해봅니다.',
  ...
  lab:{
    ...
    params:{mode:'sixty'},
    intro:{
      ko:'cos60°=1/2 — −2bc·cosA는 −bc로 간단해집니다!',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 둔각(120°) 삼각형의 변까지 모두 구합니다!', en:'Find every side of an obtuse (120°) triangle, all within 5 minutes!', zh:'5分钟内求出所有120°钝角三角形的边！' }
  },
