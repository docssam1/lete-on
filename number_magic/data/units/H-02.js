  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 모자란 만큼을 적어요',en:'1) Write down what\'s missing',zh:'① 写下差多少'},
        ...
        mathSteps:['100−96=4, 100−93=7',{ko:'96−7 = 89 (앞자리)',en:'96−7 = 89 \\text{ (front part)}',zh:'96−7 = 89（前段）'},{ko:'4×7 = 28 (뒷자리)',en:'4×7 = 28 \\text{ (back part)}',zh:'4×7 = 28（后段）'},'89 | 28 = 8928'],
      ...
      { tag:{ko:'② 100을 넘으면 반대로 빼요',en:'2) Over 100? Subtract instead',zh:'② 超过100就改成减'},
        ...
        mathSteps:[{ko:'100+3−3=100 (앞자리)',en:'100+3−3=100 \\text{ (front part)}',zh:'100+3−3=100（前段）'},{ko:'3×3=9 (뒷자리, 빼기)',en:'3×3=9 \\text{ (back part, subtract)}',zh:'3×3=9（后段，要减）'},'100×100−9 = 9991'],
