  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 사이에 넣기 마법',en:'1) The drop-in-the-middle trick',zh:'① 中间插入魔法'},
        ...
        mathSteps:['27 × 11',{ko:'앞:2  가운데:2+7=9  뒤:7',en:'\\text{front: }2\\;\\text{ middle: }2+7=9\\;\\text{ back: }7',zh:'前：2 中：2+7=9 后：7'},'= 297'],
      ...
      { tag:{ko:'② 올림이 있을 때',en:'2) When there\'s a carry',zh:'② 有进位时'},
        ...
        mathSteps:['85 × 11',{ko:'8+5 = 13 → 가운데 3, 올림 1',en:'8+5 = 13 → \\text{middle 3, carry 1}',zh:'8+5 = 13 → 中间3，进1'},{ko:'앞: 8+1=9',en:'\\text{front: } 8+1=9',zh:'前：8+1=9'},'= 935'],
