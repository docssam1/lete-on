  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 기본 기호와 값을 외워요', en:'1) Memorize the basic symbols and values', zh:'① 记住基本符号和值' },
        ...
        desc:{ ko:'I=1, V=5, X=10, L=50, C=100. 왼쪽부터 큰 순서면 더해요: VIII=5+1+1+1=8!',
               en:'I=1, V=5, X=10, L=50, C=100. Left to right if descending, add: VIII=5+1+1+1=8!',
               zh:'I=1，V=5，X=10，L=50，C=100。从左到右如果从大到小就相加：VIII=5+1+1+1=8！' },
      ...
      { tag:{ ko:'② 빼기 규칙: 작은 것이 앞에 오면 빼요', en:'2) Subtraction rule: smaller before larger means subtract', zh:'② 减法规则：小符号在大符号前表示相减' },
        ...
        desc:{ ko:'IV: I(1)이 V(5) 앞에 → 5-1=4. IX: I(1)이 X(10) 앞에 → 10-1=9. XIV=X+IV=10+4=14!',
               en:'IV: I(1) before V(5) → 5−1=4. IX: I(1) before X(10) → 10−1=9. XIV=X+IV=10+4=14!',
               zh:'IV：I(1)在V(5)前→5-1=4。IX：I(1)在X(10)前→10-1=9。XIV=X+IV=10+4=14！' },
