...
window.NM_UNITS['M-81'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 꼭짓점을 알 때', en:'1) When you know the vertex', zh:'① 已知顶点时' },
        ...
        desc:{ ko:'꼭짓점이 (2, 3)이니 y=a(x−2)²+3까지는 바로 써요. 남은 a는 지나는 점 (4, 11)을 넣어 11=a×4+3, 4a=8, <b>a=2</b>로 구해요.', en:'A vertex at (2, 3) gets you straight to y=a(x-2)2+3. For a, substitute the point (4, 11): 11 = 4a+3, so 4a = 8 and <b>a = 2</b>.', zh:'顶点是(2, 3)，所以直接写到y=a(x−2)²+3。剩下的a代入点(4, 11)：11=a×4+3，4a=8，<b>a=2</b>。' },
        mathSteps:['y = a(x-2)^2 + 3', '11 = a \\times 4 + 3', 'a = 2'],
        result:{ ko:'맞는 꼴로 시작하면 점 하나로 끝나요!', en:'Start from the right form and one point finishes it!', zh:'从对的形式入手，一个点就够了！' },
        book:{ ko:'점을 넣을 때 <b>x부터 넣어 괄호 안을 먼저 계산</b>하세요. (4−2)²=4를 먼저 구해 두면 남는 것은 간단한 일차방정식 하나뿐이에요.', en:'When substituting, <b>put x in and work out the bracket first</b>. Once (4-2)2 = 4 is done, all that remains is a simple linear equation.', zh:'代入时<b>先代x，先算括号</b>。先求出(4−2)²=4，剩下的就只是一个简单的一元一次方程。' } },
      ...
      { tag:{ ko:'② x축과의 두 교점을 알 때', en:'2) When you know both x-intercepts', zh:'② 已知与x轴的两个交点时' },
        ...
        desc:{ ko:'두 교점이 1과 3이면 <b>인수분해된 꼴</b>로 바로 쓸 수 있어요. 이 꼴은 x=1과 x=3에서 y가 0이 되는 것이 한눈에 보여요. 남은 a는 역시 다른 점 하나로 정해요.', en:'Intercepts at 1 and 3 let you write the <b>already-factored</b> form, where it is plain to see that y is zero at x=1 and x=3. One further point then fixes a.', zh:'两个交点是1和3，就能直接写成<b>因式分解好的形式</b>，一眼就能看出x=1和x=3时y为0。剩下的a同样用另一个点确定。' },
        mathSteps:['y = a(x-1)(x-3)', {ko:'\\text{다른 점으로 } a \\text{ 결정}',en:'\\text{another point fixes } a',zh:'\\text{用另一个点确定 } a'}],
        result:{ ko:'주어진 것에 맞는 꼴을 고르는 것이 절반이에요!', en:'Choosing the form that fits is half the work!', zh:'选对形式就完成了一半！' },
        book:{ ko:'표준형과 일반형은 같은 식의 두 얼굴이에요. y=(x−2)²+3을 전개하면 y=x²−4x+7이고, 거꾸로 완전제곱을 하면 되돌아와요 — 필요한 쪽으로 <b>오갈 수 있어야</b> 해요.', en:'Vertex form and general form are two faces of one formula: expanding y=(x-2)2+3 gives y=x2-4x+7, and completing the square brings it back. You need to be able to <b>travel both ways</b>.', zh:'顶点式和一般式是同一个式子的两副面孔：展开y=(x−2)²+3得y=x²−4x+7，配方又能回去——要能<b>来回自如</b>。' } }
    ],
  ...
  check:{
    ...
    open:{ ko:'꼭짓점을 알 때와 두 교점을 알 때 시작하는 꼴이 왜 다른지 말해봐요.', en:'Explain why the starting form differs for a vertex and for two intercepts.', zh:'说说已知顶点和已知两交点时，为什么起始形式不同。' },
  ...
  arena:{
    ...
    params:{mode:'general'},
    rule:{ ko:'6분 안에 표준형을 전개해 일반형의 b와 c를 구해요!', en:'Within 6 minutes, expand the vertex form and get b and c!', zh:'6分钟内展开顶点式，求出一般式的b和c！' }
  },
