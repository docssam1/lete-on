  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 왜 자릿수를 예측할까?',en:'1) Why predict digits?',zh:'① 为什么预测位数？'},
        ...
        mathSteps:['23 × 41 ≈ ?','20 × 40 = 800',{ko:'→ 답은 800보다 커요',en:'→ \\text{the answer is bigger than 800}',zh:'→ 答案比800大'},{ko:'→ 최소 3자리!',en:'→ \\text{at least 3 digits!}',zh:'→ 至少3位数！'}],
      ...
      { tag:{ko:'② 십의 자리끼리 곱하기',en:'2) Multiply the tens digits',zh:'② 十位相乘'},
        ...
        mathSteps:['47 × 38',{ko:'4 × 3 = 12 (앞자리 곱)',en:'4 × 3 = 12 \\text{ (leading digits)}',zh:'4 × 3 = 12（首位相乘）'},'40×30 = 1200',{ko:'→ 4자리 예측!',en:'→ \\text{predict 4 digits!}',zh:'→ 预计4位数！'}],
      ...
      { tag:{ko:'③ 예측 → 계산 → 확인',en:'3) Predict → compute → verify',zh:'③ 预测→计算→验证'},
        ...
        mathSteps:[{ko:'① 예측: 3×2=6 → 3자리쯤',en:'① \\text{predict: } 3×2=6 → \\text{about 3 digits}',zh:'① 预测：3×2=6 → 大约3位'},{ko:'② 계산: 34×26=884',en:'② \\text{calculate: } 34×26=884',zh:'② 计算：34×26=884'},{ko:'③ 확인: 884는 3자리 ✓',en:'③ \\text{check: 884 has 3 digits} ✓',zh:'③ 检查：884是3位数 ✓'}],
