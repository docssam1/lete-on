...
window.NM_UNITS['M-34'] = {
  ...
  subtitle:{ ko:'평행은 계수 비율이 같고, 수직은 기울기의 곱이 -1입니다', en:'Parallel lines share a coefficient ratio; perpendicular slopes multiply to -1', zh:'平行时系数比相同，垂直时斜率之积为-1' },
  icon:'🧭',
  ...
  practice:{
    ...
    intro:{
      ko:'2x+3y+1=0과 4x+ky+5=0이 평행하려면? x,y의 계수 비율이 같아야 합니다 — 2:3=4:k이니 k=6.',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'두 직선이 평행한지, 수직인지 그림 없이 식만 보고 알 수 있을까요? 계수 안에 그 답이 숨어 있다고 합니다.',
      ...
      history:{ ko:'평행한 직선은 기울기가 완전히 같습니다 — 방향이 같기 때문입니다. 수직인 직선은 기울기끼리 곱하면 항상 -1이 됩니다 — 90도로 꺾인 두 방향의 관계가 만드는 성질입니다. 이 두 사실만 알면 그림 없이도 판단할 수 있습니다.',
    ...
    stages:[
      { tag:{ko:'① 평행: 계수 비율이 같다',en:'1) Parallel: matching coefficient ratios',zh:'① 平行：系数比相同'},
        ...
        desc:{ko:'첫 직선의 x,y 계수 비율은 2:3. 둘째 직선도 같은 비율이어야 하니 4:k=2:3 — 4가 2의 2배이니 k도 3의 2배인 <b>6</b>입니다.',
        ...
        result:{ko:'평행하려면 x,y의 계수 비율이 완전히 같아야 합니다!',en:'For parallel lines, the x,y coefficient ratios must match exactly!',zh:'平行时x、y的系数比必须完全相同！'},
      ...
      { tag:{ko:'② 수직: 계수를 엇갈려 곱해 더하면 0',en:'2) Perpendicular: cross-multiply and sum to 0',zh:'② 垂直：交叉相乘之和为0'},
        ...
        desc:{ko:'수직 조건은 Ak+BD=0. 여기선 3×k+2×(-6)=0 → 3k=12 → k=<b>4</b>. 기울기로 확인하면 -3/2와 -k/(-6)=k/6의 곱이 -1이 되는 것과 같습니다.',
        ...
        book:{ko:'Ax+By+C=0과 A′x+B′y+C′=0이 수직 ⟺ AA′+BB′=0 — 기울기의 곱이 -1이라는 것과 같은 뜻입니다.',
  ...
  arena:{
    ...
    params:{mode:'mixed'},
    rule:{ ko:'5분 안에 평행·수직이 섞인 문제를 모두 풉니다!', en:'Solve all the mixed parallel/perpendicular problems in 5 minutes!', zh:'5分钟内解答所有平行·垂直混合题！' }
  },
