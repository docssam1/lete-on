  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'② 직각이등변삼각형은 45°',en:'2) The right-isosceles triangle: 45°',zh:'② 等腰直角三角形：45°'},
        ...
        desc:{ko:'두 변이 1인 직각이등변삼각형은 빗변이 √2예요(피타고라스). 그래서 sin45°=1/√2=√2/2. tan은 마주보는 변÷붙어 있는 변이라 빗변이 사라져요 — tan60°=(√3/2)÷(1/2)=√3, 근호만 남고 분모가 없어져요.',
              en:'A right-isosceles triangle with legs 1 has hypotenuse √2 (Pythagoras). So sin45°=1/√2=√2/2. Since tan is opposite÷adjacent, the hypotenuse cancels — tan60°=(√3/2)÷(1/2)=√3, leaving only the root with no denominator.',
              zh:'两条直角边都是1的等腰直角三角形，斜边是√2(勾股定理)。所以sin45°=1/√2=√2/2。tan是对边÷邻边，斜边会消掉——tan60°=(√3/2)÷(1/2)=√3，只剩根号，没有分母。'},
