...
window.NM_UNITS['M-39'] = {
  ...
  subtitle:{ ko:'0°·30°·45°·60°·90° 다섯 각의 sin·cos·tan을 외웁니다', en:'Memorize sin·cos·tan at five special angles', zh:'记住五个特殊角的sin·cos·tan' },
  icon:'📐',
  ...
  practice:{
    ...
    params:{mode:'basic'},
    intro:{
      ko:'sin30° = 1/2 — 정삼각형을 반으로 잘랐을 때 나오는 직각삼각형의 변의 비입니다.',
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 정삼각형을 반으로 자르면 30°·60°',en:'1) Bisect an equilateral triangle: 30° & 60°',zh:'① 等边三角形对半切开：30°·60°'},
        ...
        desc:{ko:'한 변이 2인 정삼각형을 반으로 자르면, 빗변 2·높이 √3·밑변 1인 직각삼각형이 나옵니다. <b>30°와 마주 보는 변은 1(가장 짧은 변)</b> → sin30°=1/2. 60°와 마주 보는 변은 √3 → sin60°=√3/2.',
        ...
        book:{ko:'sin=마주보는 변÷빗변, cos=붙어 있는 변÷빗변, tan=마주보는 변÷붙어 있는 변입니다.',
      ...
      { tag:{ko:'② 직각이등변삼각형은 45°',en:'2) The right-isosceles triangle: 45°',zh:'② 等腰直角三角形：45°'},
        ...
        desc:{ko:'두 변이 1인 직각이등변삼각형은 빗변이 √2입니다(피타고라스). 그래서 sin45°=1/√2=√2/2. tan은 마주보는 변÷붙어 있는 변이라 <b>빗변이 사라집니다</b> — tan60°=(√3/2)÷(1/2)=√3, 근호만 남고 분모가 없어집니다.',
        ...
        result:{ko:'45°는 √2가, 60°의 tan은 분모 없이 √3만 남습니다!',en:'45° brings in √2, and tan60° leaves only √3 with no denominator!',zh:'45°带出√2，tan60°只剩下没有分母的√3！'},
        book:{ko:'0°와 90°는 축 위의 값이라 근호 없이 0과 1만 나옵니다 — 다섯 각 전체를 표로 외워두면 계산 없이 바로 답할 수 있습니다.',
    ...
    rule:{ ko:'30-60-90 삼각형의 변의 비는 1:√3:2, 45-45-90은 1:1:√2 — 이 두 삼각형이 특수각 값의 전부입니다.',
  ...
  check:{
    fills:[
      { tex:'\\cos 60^\\circ = \\dfrac{\\square}{\\square}', answer:[1,2],
        hint:{ ko:'cos60°는 sin30°와 같은 값입니다', en:'cos60° has the same value as sin30°', zh:'cos60°和sin30°的值相同' } },
      { tex:'\\tan 45^\\circ = \\square', answer:1,
        hint:{ ko:'직각이등변삼각형은 두 변의 길이가 같습니다', en:'A right-isosceles triangle has two equal legs', zh:'等腰直角三角形两条直角边相等' } }
    ],
    open:{ ko:'cos45°의 값을 직각이등변삼각형의 변의 비로 설명해봅니다.',
  ...
  arena:{
    ...
    params:{mode:'wide'},
    rule:{ ko:'5분 안에 sin·cos·tan 특수각 값을 모두 맞힙니다!', en:'Answer all the sin·cos·tan special-angle values in 5 minutes!', zh:'5分钟内答对所有sin·cos·tan特殊角的值！' }
  },
