  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'③ 뺄셈도 똑같이',en:'3) Subtraction too',zh:'③ 减法也一样'},
        ...
        mathSteps:['5830 - 2380','= 3450','검산: 3450 + 2380 = 5830 ✓'],
...
window.NM_UNITS['T-NS1'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 조회수 이야기',en:'1) View-count story',zh:'① 播放量的故事'},
        ...
        mathSteps:['47382','4🔟000 7000 300 80 2','= 4만 7천 3백 8십 2'],
      ...
      { tag:{ko:'② 자리의 값',en:'2) Value of a place',zh:'② 数位的值'},
        ...
        mathSteps:['44444','= 40000+4000+400+40+4','왼쪽 한 칸 = ×10'],
      ...
      { tag:{ko:'③ 뛰어세기',en:'3) Skip counting',zh:'③ 跳数'},
        ...
        mathSteps:['23000 → 33000 → 43000','만의 자리: 2→3→4','나머지 자리는 그대로!'],
  ...
  check:{
    fills:[
      { tex:'23456 \\;\\rightarrow\\; \\text{천의 자리} = \\square', answer:3,
        hint:{ ko:'오른쪽에서 네 번째 자리', en:'4th digit from the right', zh:'从右数第四位' } },
      { tex:'23456 \\;\\rightarrow\\; \\text{만의 자리} = \\square', answer:2,
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 쿠키 나누기',en:'1) Sharing cookies',zh:'① 分饼干'},
        ...
        mathSteps:['🍪12개 ÷ 3명','한 명당 4개씩','12 ÷ 3 = 4'],
      ...
      { tag:{ko:'③ 묶어 세기',en:'3) Grouping',zh:'③ 分组数'},
        ...
        mathSteps:['12개를 3개씩','3, 6, 9, 12','= 4묶음'],
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 남는 사탕',en:'1) Leftover candies',zh:'① 剩下的糖'},
        ...
        mathSteps:['13 ÷ 4','4×3=12, 남은 것 1','몫 3, 나머지 1'],
      ...
      { tag:{ko:'② 나머지의 규칙',en:'2) The remainder rule',zh:'② 余数的规则'},
        ...
        mathSteps:['÷4의 나머지','0, 1, 2, 3만 가능','나머지 ≥ 4 → 몫 +1!'],
      ...
      { tag:{ko:'③ 생활 속 나머지',en:'3) Remainders in life',zh:'③ 生活中的余数'},
        ...
        mathSteps:['13÷4 = 3…1','보트: 4척 (올림!)','리본: 3개 (버림!)'],
  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'③ 어림 감각',en:'3) Estimation sense',zh:'③ 估算感觉'},
        ...
        mathSteps:['214×3 어림','200×3 = 600','답은 600보다 크다!'],
...
window.NM_UNITS['T-FR1'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 피자 한 조각',en:'1) One pizza slice',zh:'① 一块比萨'},
        ...
        mathSteps:['🍕 4조각으로 똑같이','1조각 먹음','= \\dfrac{1}{4}'],
      ...
      { tag:{ko:'② 똑같이가 생명',en:'2) EQUAL is everything',zh:'② "平均"是关键'},
        ...
        mathSteps:['❌ 크기 다른 4조각','⭕ 똑같은 4조각','분수 = 똑같이 나눈 것!'],
      ...
      { tag:{ko:'③ 남은 부분도 분수',en:'3) The rest is a fraction too',zh:'③ 剩下的也是分数'},
        ...
        mathSteps:['8조각 중 3조각 먹음','남은 조각: 8-3=5','남은 부분 = \\dfrac{5}{8}'],
  ...
  check:{
    fills:[
      { tex:'\\text{8조각 중 3조각} = \\dfrac{\\square}{8}', answer:3,
        hint:{ ko:'분자 = 세는 조각 수(위)', en:'Numerator = pieces counted (top)', zh:'分子=所取块数(上)' } },
      { tex:'\\dfrac{2}{\\square} = \\text{5조각 중 2조각}', answer:5,
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 케이크 7조각',en:'1) Seven cake pieces',zh:'① 7块蛋糕'},
        ...
        mathSteps:['\\dfrac{7}{4}','4조각 = 1판, 3조각 남음','= 1\\dfrac{3}{4}'],
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 같은 피자, 다른 이름',en:'1) Same pizza, different name',zh:'① 同一块比萨，不同名字'},
        ...
        mathSteps:['\\dfrac{6}{8} = \\dfrac{6 \\div 2}{8 \\div 2}','= \\dfrac{3}{4}','크기는 그대로!'],
      ...
      { tag:{ko:'② 공약수 찾기',en:'2) Finding common factors',zh:'② 找公因数'},
        ...
        mathSteps:['\\dfrac{6}{9}','공약수 3으로 나누기','= \\dfrac{2}{3}'],
      ...
      { tag:{ko:'③ 끝까지 간단하게',en:'3) Simplify to the end',zh:'③ 约到最简'},
        ...
        mathSteps:['\\dfrac{12}{16} \\rightarrow \\dfrac{6}{8}','\\rightarrow \\dfrac{3}{4}','기약분수 완성!'],
...
window.NM_UNITS['T-DV3'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 타일 직사각형',en:'1) Tile rectangles',zh:'① 瓷砖长方形'},
        ...
        mathSteps:['12장의 타일','1×12, 2×6, 3×4','약수: 1,2,3,4,6,12 (6개)'],
      ...
      { tag:{ko:'② 짝 사냥법',en:'2) Pair hunting',zh:'② 成对猎因数'},
        ...
        mathSteps:['18의 약수','1·18, 2·9, 3·6','= 6개'],
      ...
      { tag:{ko:'③ 특별한 수들',en:'3) Special numbers',zh:'③ 特别的数'},
        ...
        mathSteps:['7의 약수: 1, 7','2개뿐 → 소수!','12: 6개 → 친절한 수'],
  ...
  check:{
    fills:[
      { tex:'12\\text{의 약수 개수} = \\square', answer:6,
        hint:{ ko:'1·12, 2·6, 3·4', en:'1&12, 2&6, 3&4', zh:'1·12，2·6，3·4' } },
      { tex:'10\\text{의 약수 개수} = \\square', answer:4,
...
window.NM_UNITS['T-DC1'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 물병 이야기',en:'1) Water bottle story',zh:'① 水瓶的故事'},
        ...
        mathSteps:['1L를 10칸으로','한 칸 = 0.1 = \\dfrac{1}{10}','3칸 = 0.3'],
      ...
      { tag:{ko:'③ 소수의 자리',en:'3) Decimal places',zh:'③ 小数的数位'},
        ...
        mathSteps:['3.7','3 = 일의 자리, 7 = 십분의 자리','0.9 < 1.2 (일의 자리 비교)'],
  ...
  check:{
    fills:[
      ...
      { tex:'5.8 \\;\\rightarrow\\; \\text{소수 첫째 자리} = \\square', answer:8,
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 문방구 이야기',en:'1) Stationery story',zh:'① 文具店的故事'},
        ...
        mathSteps:['300 + 200×3','200×3 = 600 (먼저!)','300 + 600 = 900'],
