  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'② 대각선 띠로 모아 더하기',en:'2) Gathering the diagonal bands',zh:'② 沿对角带汇总相加'},
        ...
        mathSteps:[{ko:'일 자리 띠부터 합산',en:'\\text{add up from the ones stripe}',zh:'从个位斜条开始相加'},{ko:'10 넘으면 다음 띠로 올림',en:'\\text{carry to the next stripe past 10}',zh:'满10向下一条进位'},{ko:'왼쪽 위부터 읽기 = 답',en:'\\text{read from top-left = answer}',zh:'从左上读出来 = 答案'}],
      ...
      { tag:{ko:'③ 342×67 완주하기',en:'3) Completing 342×67',zh:'③ 完成342×67'},
        ...
        mathSteps:[{ko:'×6줄: 18, 24, 12',en:'×6 \\text{ row: } 18, 24, 12',zh:'×6行：18, 24, 12'},{ko:'×7줄: 21, 28, 14',en:'×7 \\text{ row: } 21, 28, 14',zh:'×7行：21, 28, 14'},{ko:'대각선 띠 합+올림 → 22914',en:'\\text{diagonal sums + carries} → 22914',zh:'对角线相加+进位 → 22914'}],
