  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 앞 두 자리·뒤 두 자리로 쪼개요', en:'1) Split into front pair + back pair', zh:'① 拆成前两位和后两位' },
        ...
        desc:{ ko:'1234는 앞쪽 12×100=1200 과 뒤쪽 34 로 이루어져 있어요. 덧셈할 때 앞끼리, 뒤끼리 따로 더하면 쉬워져요!',
               en:'1234 is made of front 12×100=1200 and back 34. When adding, work front+front and back+back separately!',
               zh:'1234由前面12×100=1200和后面34组成。做加法时，前面加前面、后面加后面，更简单！' },
        mathSteps:['1234 + 5678','앞: 12 + 56 = 68 → 6800','뒤: 34 + 78 = 112','6800 + 112 = 6912'],
      ...
      { tag:{ ko:'② 쪼갠 뒤 합산하기', en:'2) Combine the partial sums', zh:'② 合并部分和' },
        ...
        desc:{ ko:'앞 두 자리 합×100 + 뒤 두 자리 합 = 전체 합. 이 순서를 지키면 항상 정확해요.',
               en:'Front sum × 100 + Back sum = Total. Follow this order and you\'ll always be correct.',
               zh:'前两位和×100 + 后两位和 = 总和。按这个顺序，永远准确！' },
        mathSteps:['3412 + 5281','앞: 34 + 52 = 86 → 8600','뒤: 12 + 81 = 93','8600 + 93 = 8693'],
