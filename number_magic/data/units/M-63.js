...
window.NM_UNITS['M-63'] = {
  ...
  subtitle:{ ko:'한 문자를 없애면 아는 문제로 돌아옵니다', en:'Get rid of one letter and it becomes a problem you already know', zh:'消去一个字母，就回到已经会的问题' },
  icon:'🔗',
  ...
  practice:{
    ...
    intro:{
      ko:'y가 무엇인지 이미 알려 준 식이 있습니다 — 그대로 다른 식의 y 자리에 넣어 보세요!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'사과 2개와 배 1개가 1100원, 사과 1개와 배 1개가 800원입니다. 사과 한 개 값은? 두 줄을 나란히 놓고 빼 보면 사과 한 개가 딱 300원이라는 게 보입니다. 미지수가 둘이어도 식이 둘이면 답은 하나로 정해집니다.',
      ...
      history:{ ko:'연립방정식은 서양보다 동양이 훨씬 빨랐습니다. 기원전 중국의 『구장산술』 제8장의 이름이 바로 "방정(方程)"인데, 벼의 수확량을 묻는 연립방정식을 계수만 네모나게 늘어놓고 줄끼리 빼 나가며 풉니다 — 1800년대 서양에서 "가우스 소거법"이라 부르게 된 방법과 같습니다.',
    ...
    stages:[
      { tag:{ko:'① 대입법 — 이미 풀린 식을 그대로 넣기',en:'1) Substitution — put the solved equation straight in',zh:'① 代入法——把已解出的式子直接代入'},
        ...
        desc:{ko:'첫 식이 y가 무엇인지 알려 주니, 둘째 식의 y 자리에 <b>그대로</b> 넣습니다. 그러면 x만 남은 일차방정식이 되고, 우리는 이미 그걸 풀 줄 압니다.',
        ...
        result:{ko:'미지수를 하나로 줄이는 게 목적입니다!',en:'The whole point is to cut the unknowns down to one!',zh:'目的就是把未知数减到一个！'},
        book:{ko:'x를 구하고 끝내면 안 됩니다 — 연립방정식의 답은 x와 y의 <b>짝</b>입니다. 구한 x를 다시 넣어 y까지 구해야 끝납니다.',
      ...
      { tag:{ko:'② 가감법 — 계수를 맞춘 뒤 빼기',en:'2) Elimination — match the coefficients, then subtract',zh:'② 加减法——配好系数再相减'},
        ...
        desc:{ko:'두 식의 x 계수가 둘 다 2입니다. 위에서 아래를 빼면 x가 통째로 사라지고 2y=6만 남습니다. 계수가 다를 때는 서로 곱해서 같게 만든 다음 뺍니다.',
        ...
        result:{ko:'계수를 같게 만들면 빼기만으로 사라집니다!',en:'Once the coefficients match, one subtraction makes it vanish!',zh:'系数变成相同后，只要一减就消失了！'},
        book:{ko:'부호가 반대면(+2y와 −2y) 빼는 대신 <b>더합니다</b>. 그래서 이름이 "가감법" — 더하거나 빼거나 둘 중 편한 쪽입니다.',
    ...
    rule:{ ko:'미지수가 둘이면 식도 둘 — 대입법이든 가감법이든 한 문자를 없애 일차방정식으로 되돌리는 게 전부입니다!',
  ...
  check:{
    ...
    open:{ ko:'2x+y=8, x−y=1을 가감법으로 푸는 과정을 말해봅니다.',
  ...
  arena:{
    ...
    rule:{ ko:'6분 안에 계수를 보고 더 빠른 방법을 골라 풉니다!', en:'Within 6 minutes, look at the coefficients and pick the faster method!', zh:'6分钟内看系数选出更快的方法来解！' }
  },
