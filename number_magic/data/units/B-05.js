  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 5단 = 5씩 뛰어세기!', en:'1) ×5 = skip count by 5!', zh:'① 乘5=5个5个地数！' },
        ...
        desc:{ ko:'5×1=5, 5×2=10, 5×3=15... 시계의 분 단위와 똑같아요! 5씩 뛰어 세면 5단이 완성돼요.',
               en:'5×1=5, 5×2=10, 5×3=15 … just like the minute hand on a clock! Skip by 5 and you know the 5s table.',
               zh:'5×1=5，5×2=10，5×3=15……和时钟的分钟刻度一模一样！5个5个跳就能记住5的乘法。' },
      ...
      { tag:{ ko:'② 끝자리 패턴', en:'2) Last-digit pattern', zh:'② 末位规律' },
        ...
        desc:{ ko:'5×1=5(끝:5), 5×2=10(끝:0), 5×3=15(끝:5), 5×4=20(끝:0)... 0과 5가 번갈아 나와요!',
               en:'5×1=5 (ends 5), 5×2=10 (ends 0), 5×3=15 (ends 5), 5×4=20 (ends 0) … 0 and 5 take turns!',
               zh:'5×1=5（末位5），5×2=10（末位0），5×3=15（末位5），5×4=20（末位0）……0和5交替出现！' },
        mathSteps:['5×1=5 (끝:5)','5×2=10 (끝:0)','5×3=15 (끝:5)','5×4=20 (끝:0)','→ 0과 5 반복!'],
      ...
      { tag:{ ko:'③ 2단과의 관계', en:'3) Connection to the 2s table', zh:'③ 与2的乘法的关系' },
        ...
        mathSteps:['5×4 = 2×10?','5×4=20, 2×10=20 ✓','5 × 짝수 = 2 × (5배의 절반)'],
