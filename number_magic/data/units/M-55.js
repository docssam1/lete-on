...
window.NM_UNITS['M-55'] = {
  ...
  subtitle:{ ko:'변과 대각을 외접원의 지름으로 잇습니다', en:'A side and its opposite angle connect to the circumscribed circle', zh:'边与对角连接着外接圆的直径' },
  icon:'🔺',
  ...
  practice:{
    ...
    params:{mode:'basic'},
    intro:{
      ko:'사인법칙 a/sinA = 2R — 한 변을 그 대각의 sin값으로 나누면 항상 외접원의 지름(2R)이 나옵니다!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'어떤 삼각형이든 세 변과 그 대각의 사인값의 비(변÷sin각)는 항상 똑같습니다 — 심지어 그 값은 삼각형을 둘러싼 원(외접원)의 지름(2R)과도 같습니다! 삼각형이 아무리 달라 보여도 이 관계는 변하지 않습니다.',
      ...
      history:{ ko:'사인법칙은 10~11세기 페르시아 수학자 아부 알와파와 알비루니가 천문학(별의 위치 계산)을 위해 연구했습니다. 삼각법은 원래 하늘의 별을 측량하려는 필요에서 태어난 학문입니다.',
    ...
    stages:[
      { tag:{ko:'① 변÷sin(대각) = 2R(외접원의 지름)',en:'1) side÷sin(opposite angle) = 2R (diameter of the circumcircle)',zh:'① 边÷sin(对角) = 2R(外接圆直径)'},
        ...
        desc:{ko:'sin30°=1/2입니다. 그러니 6÷(1/2)는 나눗셈이 아니라 <b>6×2=12</b>로 바로 계산됩니다(분수로 나누는 건 그 역수를 곱하는 것과 같아요).',
        ...
        result:{ko:'sinA가 1/2이면 나눗셈이 곱셈(×2)으로 바뀝니다!',en:'When sinA is 1/2, the division turns into multiplication (×2)!',zh:'sinA是1/2时，除法就变成了乘法(×2)！'},
        book:{ko:'sin90°=1이면 6÷1=6, 그러니 90°일 땐 변의 길이가 곧 2R이 됩니다.',
              en:'When sin90°=1, 6÷1=6 — so at 90°, the side length equals 2R directly.',
              zh:'sin90°=1时，6÷1=6——所以90°时边长本身就是2R。'} },

      { tag:{ko:'② 45°는 √2/2 — 근호가 그대로 남습니다',en:'2) At 45°, √2/2 leaves a root behind',zh:'② 45°是√2/2——根号会留下来'},
        ...
        desc:{ko:'sin45°=√2/2입니다. 4÷(√2/2)=4×(2/√2)=8/√2인데, 분모의 근호를 없애면(유리화) <b>4√2</b>가 됩니다. 결과는 계수와 근호 안의 수, 두 정수로 받습니다.',
        ...
        result:{ko:'45°는 √2/2라서 답에 근호가 그대로 남습니다!',en:'At 45°, since sin is √2/2, the root stays in the answer!',zh:'45°时sin是√2/2，答案会留下根号！'},
        book:{ko:'60°(sin=√3/2)는 근호와 분수가 겹쳐 더 복잡해져서, 이 유닛에서는 정수·근호 두 형태로 딱 떨어지는 30°·45°·90°만 다룹니다.',
    ...
    rule:{ ko:'사인법칙 a/sinA = 2R — 30°·90°는 정수로, 45°는 [계수,근호안] 두 정수로 딱 떨어집니다!',
  ...
  check:{
    ...
    open:{ ko:'6/sin45° = 2R을 유리화 과정과 함께 설명해봅니다.',
  ...
  lab:{
    ...
    intro:{
      ko:'45°는 sinA=√2/2 — 나눗셈을 곱셈으로 바꾸고 유리화합니다!',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 사인법칙을 거꾸로 써서 변까지 구합니다!', en:'Reverse the law of sines to find the side, all within 5 minutes!', zh:'5分钟内反过来用正弦定理求出边长！' }
  },
