...
window.NM_UNITS['M-02'] = {
  ...
  subtitle:{ ko:'같은 부호는 더하고, 다른 부호는 빼고 — 큰 쪽 부호를 따라갑니다', en:'Same sign: add. Different sign: subtract and follow the bigger one', zh:'同号相加，异号相减——跟着绝对值大的那个符号走' },
  icon:'⚖️',
  ...
  discover:{
    story:{
      hook:{ ko:'용돈 5만 원이 있는데 빌린 돈이 3만 원입니다. 지금 내 돈은 얼마일까요?',
        en:'You have 50,000 won of pocket money and owe 30,000 won. How much is really yours?',
        zh:'你有5万韩元零花钱，还欠3万韩元。你实际有多少钱？' },
      history:{ ko:'인도의 수학자들은 서기 628년 무렵 이미 재산은 +, 빚은 −로 두고 계산 규칙을 정리했습니다. 음수는 어려워서 늦게 나온 게 아니라, 장사와 이자 계산이라는 아주 실용적인 필요에서 먼저 태어났습니다.',
    ...
    stages:[
      { tag:{ko:'① 부호가 같으면 더하기',en:'1) Same sign — just add',zh:'① 同号就相加'},
        ...
        desc:{ko:'해저 4m에서 7m를 더 내려가면 해저 11m — <b>절댓값끼리 더하고(4+7=11) 공통 부호(−)</b>를 붙이면 끝입니다. 양수끼리도 똑같아요: (+2)+(+5)=+7.',
        ...
        result:{ko:'부호가 같으면 크기만 합치면 됩니다!',en:'Same sign? Just combine the sizes!',zh:'同号只需合并大小！'},
        book:null },
  ...
  check:{
    ...
    open:{ ko:'(+9) + (−14)를 계산하고, 어떤 규칙을 썼는지 설명해봅니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 세 수 혼합 덧뺄셈을 모두 풉니다!', en:'Solve all three-number ± chains in 5 minutes!', zh:'5分钟内解答所有三数加减混合题！' }
  },
