...
window.NM_UNITS['M-70'] = {
  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ ko:'② 원가 → 정가 → 판매가', en:'2) Cost, then marked price, then selling price', zh:'② 成本 → 定价 → 售价' },
        ...
        book:{ ko:'20% 올렸다가 20% 내리면 원래대로 돌아오지 않아요. 1.2×0.8=0.96이라 오히려 4% 손해예요 — 올릴 때와 내릴 때 <b>기준이 다르기</b> 때문이에요.', en:'Raising a price 20% and then cutting it 20% does not get you back: 1.2 x 0.8 = 0.96, a 4% loss. The rise and the fall are percentages <b>of different amounts</b>.', zh:'先涨20%再降20%回不到原价：1.2×0.8=0.96，反而亏4%——因为涨和降的<b>基准不同</b>。' } }
    ],
    rule:{ ko:'구하려는 것을 x로 놓고 → 문장을 식으로 → 풀고 → 말이 되는지 확인! 관계식만 기억하면 두 번째 걸음이 쉬워져요.', en:'Name what you want as x, turn the words into an equation, solve, then check it makes sense. Knowing the standard relations makes the second step easy.', zh:'设要求的量为x → 把句子写成算式 → 解出来 → 检验是否合理！记住关系式，第二步就容易了。' }
  },
  ...
  check:{
    ...
    open:{ ko:'거리·속력·시간 문제에서 무엇을 x로 놓을지 어떻게 정하는지 말해봐요.', en:'Explain how you decide what to call x in a distance-speed-time problem.', zh:'说说路程·速度·时间的题里怎么决定把什么设为x。' },
  ...
  arena:{
    ...
    params:{mode:'price'},
    rule:{ ko:'6분 안에 정가와 판매가를 차례로 구하고 이익까지 내요!', en:'Within 6 minutes, work out the marked price, the selling price and then the profit!', zh:'6分钟内依次求出定价、售价和利润！' }
  },
