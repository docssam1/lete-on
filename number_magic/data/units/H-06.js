  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 100으로 나눈 척 먼저',en:'1) Pretend to divide by 100',zh:'① 先假装除以100'},
        ...
        mathSteps:['6165÷100 ≈ 61 …265','(100−98)×61 = 122','265+122 = 387','387÷98 ≈ 3 …93',{ko:'몫 61+3=64, 나머지 93',en:'\\text{quotient } 61+3=64, \\text{remainder } 93',zh:'商61+3=64，余93'}],
      ...
      { tag:{ko:'② 10, 1000 근처로도 통해요',en:'2) Works near 10 and 1000 too',zh:'② 接近10和1000也行'},
        ...
        mathSteps:['542÷9: 542÷10≈54…2','(10−9)×54=54, 2+54=56',{ko:'56÷9≈6…2, 몫 54+6=60',en:'56÷9≈6…2, \\text{quotient } 54+6=60',zh:'56÷9≈6…2，商54+6=60'}],
