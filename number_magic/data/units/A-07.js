  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ ko:'② 끼리끼리 모아 더해요', en:'2) Gather same-place digits and add', zh:'② 把同位的数聚在一起相加' },
        ...
        mathSteps:['73 + 62 + 50 + 41',{ko:'= (70+60+50+40) + (3+2+0+1)  ← 끼리끼리!',en:'= (70+60+50+40) + (3+2+0+1) ← \\text{like with like!}',zh:'= (70+60+50+40) + (3+2+0+1) ← 同类在一起！'},'= 220 + 6','= 226'],
      ...
      { tag:{ ko:'③ 합치면 끝!', en:'3) Put it all together!', zh:'③ 合并就完成了！' },
        ...
        mathSteps:['35 + 42 + 13 + 24',{ko:'십의 자리: 30+40+10+20 = 100',en:'\\text{tens: } 30+40+10+20 = 100',zh:'十位：30+40+10+20 = 100'},{ko:'일의 자리: 5+2+3+4 = 14',en:'\\text{ones: } 5+2+3+4 = 14',zh:'个位：5+2+3+4 = 14'},'100 + 14 = 114'],
