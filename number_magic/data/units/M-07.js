...
window.NM_UNITS['M-07'] = {
  ...
  subtitle:{ ko:'나눗셈은 역수를 곱하는 것 — 뒤집으면 곱셈이 됩니다', en:'Division = multiply by the reciprocal — flip it and it becomes multiplication', zh:'除法＝乘以倒数——翻过来就变成乘法' },
  icon:'🔄',
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 분자는 분자끼리, 분모는 분모끼리',en:'1) Numerators together, denominators together',zh:'① 分子乘分子，分母乘分母'},
        ...
        desc:{ko:'음수가 1개(홀수)니까 부호는 −. 분자끼리 2×4=8, 분모끼리 3×5=15 → <b>−8/15</b>. 정수 곱셈의 부호 규칙이 유리수에도 그대로 통합니다.',
      ...
      { tag:{ko:'② 나눗셈은 역수를 곱합니다',en:'2) Division multiplies by the reciprocal',zh:'② 除法要乘以倒数'},
        head:{ko:'\\dfrac{3}{4} \\div \\dfrac{-2}{5} = \\dfrac{-15}{8}',en:'\\dfrac{3}{4} \\div \\dfrac{-2}{5} = \\dfrac{-15}{8}',zh:'\\dfrac{3}{4} \\div \\dfrac{-2}{5} = \\dfrac{-15}{8}'},
        desc:{ko:'두 수의 곱이 1이 되게 하는 수를 <b>역수</b>라고 합니다 — −2/5의 역수는 5/−2. 나눗셈은 나누는 수의 역수를 <b>곱셈</b>으로 바꿔서 계산해요: 3/4 × 5/(−2) = 15/(−8) = <b>−15/8</b>.',
        ...
        result:{ko:'나눗셈이 보이면 곧바로 "역수 곱셈"으로 바꿔 생각합니다!',en:'See division? Instantly rethink it as "multiply by the reciprocal"!',zh:'看到除法，立刻想成"乘以倒数"！'},
        book:{ko:'곱셈·나눗셈이 섞여 있으면 음수 개수로 부호를 먼저 정하고, 나눗셈은 전부 역수의 곱셈으로 바꾼 뒤 계산합니다.',
  ...
  check:{
    fills:[
      ...
      { tex:{ko:'\\text{역수: } \\dfrac{2}{-7} \\rightarrow \\dfrac{-7}{\\square}',en:'\\text{reciprocal: } \\dfrac{2}{-7} \\rightarrow \\dfrac{-7}{\\square}',zh:'\\text{倒数：} \\dfrac{2}{-7} \\rightarrow \\dfrac{-7}{\\square}'}, answer:2,
        hint:{ ko:'분자·분모를 뒤집습니다', en:'Flip numerator and denominator', zh:'分子分母互换' } }
    ],
    open:{ ko:'(−2/3) ÷ (4/−9)를 역수를 이용해 계산해봅니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 세 유리수 곱나눗 혼합을 모두 풉니다!', en:'Solve all three-rational × ÷ mixes in 5 minutes!', zh:'5分钟内解答所有三数有理数乘除混合题！' }
  },
