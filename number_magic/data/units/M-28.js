  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 공식에 그대로 대입',en:'1) Substitute straight into the formula',zh:'① 直接代入公式'},
        ...
        desc:{ko:'x²-3x+1=0은 a=1,b=-3,c=1. D=9-4=5이니 x=(3±√5)/2. 근호 안이 완전제곱수가 아니어도 그대로가 정답이에요.',
              en:'For x²-3x+1=0: a=1, b=-3, c=1. D=9-4=5, so x=(3±√5)/2. Even when the radicand isn\'t a perfect square, the unreduced form is the answer.',
              zh:'x²-3x+1=0中a=1，b=-3，c=1。D=9-4=5，所以x=(3±√5)/2。即使根号内不是完全平方数，不化简的形式就是答案。'},
      ...
      { tag:{ko:'② 공식이 나오는 이유(완전제곱식)',en:'2) Why the formula works (completing the square)',zh:'② 公式从何而来(配方)'},
        ...
        desc:{ko:'양변을 a로 나누고 완전제곱식으로 묶으면 이 꼴이 돼요. 양변에 제곱근을 씌우고 x를 정리하면 근의 공식이 그대로 나와요.',
              en:'Dividing by a and completing the square produces this exact form. Take the square root of both sides and isolate x, and out pops the quadratic formula.',
              zh:'两边除以a并配成完全平方式，就会得到这个形式。两边开平方并整理x，就直接得到求根公式。'},
