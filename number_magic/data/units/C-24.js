  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'③ 제곱수 무기고',en:'3) Your arsenal of squares',zh:'③ 平方数武器库'},
        ...
        book:{ko:'뒤 과정에서는 "차가 2"라는 제한을 풀어요: 기준수와 차이가 얼마든, 심지어 평균을 직접 구해서든 같은 평균²−차² 마법이 통해요.',
              en:'A later course drops the "2 apart" limit — any anchor, any gap (even one you compute as an average yourself) still obeys the same average²−gap² magic.',
              zh:'后面的课程会打破"相差2"的限制——不管基准数和差是多少，甚至自己求出平均值，同样的平均²−差²魔法都成立。'} }
    ],
