  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 두 자리 수도 일의 자리가 열쇠', en:'1) Ones digit is the key for 2-digit numbers too', zh:'① 两位数个位才是关键' },
        ...
        mathSteps:['13 → 일의 자리: 3', '67 → 일의 자리: 7', '3 + 7 = 10 → 짝꿍!'],
      ...
      { tag:{ ko:'② 짝꿍 두 쌍 찾기', en:'2) Finding two pairs', zh:'② 找出两组配对' },
        ...
        mathSteps:['13 + 86 + 67 + 24','일의 자리: 3, 6, 7, 4','3+7=10 (13과 67 짝!), 6+4=10 (86과 24 짝!)','= (13 + 67) + (86 + 24)','= 80 + 110 = 190'],
      ...
      { tag:{ ko:'③ 실전 연습', en:'3) Practice in action', zh:'③ 实战练习' },
        ...
        mathSteps:['45 + 31 + 55 + 69','일의 자리: 5+5=10 (45,55 짝), 1+9=10 (31,69 짝)','= (45+55)+(31+69)','= 100+100 = 200'],
