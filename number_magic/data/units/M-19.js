...
window.NM_UNITS['M-19'] = {
  ...
  subtitle:{ ko:'무지개 덧셈법에서 시작된 여정의 마지막 걸음 — 두 수의 합과 곱으로 답이 정해집니다', en:'The final step of a journey that began with rainbow addition — the answer is decided by the sum and product of two numbers', zh:'从彩虹加法法出发的旅程终点——答案由两数之和与积决定' },
  icon:'🌈',
  ...
  practice:{
    ...
    intro:{
      ko:'(x+2)(x+3)을 하나하나 곱하지 않아도, 2+3과 2×3만 알면 바로 답이 나옵니다!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'무지개 덧셈법 기억나요? 1+2+…+10을 (1+10)×5로 순식간에 구했었죠. 그 뒤로 "두 수를 짝지어 다루는" 감각이 계속 자라서, 이번엔 곱셈식 (x+a)(x+b)까지 왔습니다.',
      ...
      history:{ ko:'곱셈공식은 고대 그리스 수학자 유클리드의 『원론』에도 도형(정사각형·직사각형의 넓이)으로 등장합니다. 지금 우리가 문자식으로 배우는 것을, 옛날 사람들은 넓이 그림으로 이해했습니다.',
    ...
    stages:[
      { tag:{ko:'① 두 수를 더하고, 곱하기',en:'1) Add the two numbers, then multiply them',zh:'① 先加，再乘这两个数'},
        ...
        desc:{ko:'네 항을 하나씩 곱해도 되지만(전개하면 x²+3x+2x+6), 결국 가운데 항은 <b>2+3=5</b>(두 수의 합), 마지막 항은 <b>2×3=6</b>(두 수의 곱)입니다. 매번 다 곱하지 않고 이 두 값만 구하면 바로 답이 나옵니다.',
        ...
        book:{ko:'(x+a)(x+b) = x²+(a+b)x+ab. (x+a)²=x²+2ax+a²는 a=b인 특별한 경우입니다.',
      ...
      { tag:{ko:'② 부호가 반대면 가운데 항이 사라짐 — 합차공식',en:'2) Opposite signs cancel the middle term — the difference of squares',zh:'② 符号相反，中间项就消失——平方差公式'},
        ...
        desc:{ko:'a=4, b=-4를 앞의 규칙에 넣으면: 가운데 항 4+(-4)=0(사라짐!), 마지막 항 4×(-4)=-16. <b>가운데 항이 통째로 사라지고</b> x²과 -16(=-4²)만 남습니다 — 무지개 덧셈법 → 평균값 곱셈을 지나 도착한 마지막 형태입니다.',
        ...
        result:{ko:'부호가 반대인 두 수는 가운데 항이 사라지고 제곱의 차만 남습니다!',en:'Two numbers with opposite signs cancel the middle term, leaving just the difference of squares!',zh:'两数符号相反，中间项消失，只剩平方差！'},
        book:{ko:'(x+a)(x-a) = x²-a² — 이걸 <b>합차공식</b>이라고 합니다. "합"과 "차"를 곱하면 "제곱의 차"가 된다는 뜻입니다.',
  ...
  check:{
    ...
    openHint:{ ko:'x²-81. 9와 -9를 더하면 0이라 가운데 항이 사라집니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 합차공식 문제를 모두 풉니다!', en:'Solve all the difference-of-squares problems in 5 minutes!', zh:'5分钟内解答所有平方差公式题！' }
  },
