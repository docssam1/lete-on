  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 딱 떨어지는 10이 편해요', en:'1) Multiples of 10 are easy to work with', zh:'① 整十数好算' },
        ...
        mathSteps:[{ko:'38 → 40까지 2 필요 (2를 이사시켜요)',en:'38 → \\text{needs 2 to reach 40 (move 2 over)}',zh:'38 → 到40还差2（把2搬过来）'},{ko:'39 → 40까지 1 필요 (1을 이사시켜요)',en:'39 → \\text{needs 1 to reach 40 (move 1 over)}',zh:'39 → 到40还差1（把1搬过来）'},{ko:'68 → 70까지 2 필요 (2를 이사시켜요)',en:'68 → \\text{needs 2 to reach 70 (move 2 over)}',zh:'68 → 到70还差2（把2搬过来）'}],
      ...
      { tag:{ ko:'② 빌려서 이사시켜요', en:'2) Borrow and move', zh:'② 借过来再搬' },
        ...
        mathSteps:['39 + 25',{ko:'= 39 + 1 + 24  ← 25에서 1을 이사!',en:'= 39 + 1 + 24 ← \\text{move 1 from 25!}',zh:'= 39 + 1 + 24 ← 从25搬来1！'},'= 40 + 24','= 64'],
      ...
      { tag:{ ko:'③ 실전 연습', en:'3) Practice in action', zh:'③ 实战练习' },
        ...
        mathSteps:['58 + 34',{ko:'58에 2를 이사 → 60 + 32 = 92',en:'\\text{move 2 to 58} → 60 + 32 = 92',zh:'把2搬给58 → 60 + 32 = 92'},'47 + 36',{ko:'47에 3을 이사 → 50 + 33 = 83',en:'\\text{move 3 to 47} → 50 + 33 = 83',zh:'把3搬给47 → 50 + 33 = 83'}],
