  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 뺄셈을 덧셈으로 뒤집어요', en:'1) Flip subtraction to addition', zh:'① 把减法翻转成加法' },
        ...
        desc:{ ko:'73-48=? 를 <b>"48+□=73"으로 바꾸면</b>, 48에서 73까지 얼마나 더해야 할까? 를 묻는 문제가 돼요. 이게 더 쉬울 때가 많아요!',
               en:'Turn 73-48=? into "48+□=73": <b>how much to add to 48 to get 73?</b> That\'s often easier!',
               zh:'把73-48=？改成"48+□=73"：<b>从48加多少能到73？</b>这样想往往更容易！' },
        mathSteps:['73 - 48 = □',{ko:'반대로: 48 + □ = 73',en:'\\text{backwards: } 48 + □ = 73',zh:'反过来：48 + □ = 73'},{ko:'48에서 50까지: +2',en:'\\text{from 48 to 50: } +2',zh:'从48到50：+2'},{ko:'50에서 73까지: +23',en:'\\text{from 50 to 73: } +23',zh:'从50到73：+23'},'□ = 2 + 23 = 25'],
      ...
      { tag:{ ko:'② 언제 반대로 채울까요?', en:'2) When to use reverse fill?', zh:'② 什么时候用反向填空？' },
        ...
        desc:{ ko:'91-88=? → 88+□=91 → □=3. 가까운 두 수는 <b>반대로 채우기</b>로 순식간에 풀려요!',
               en:'91-88=? → 88+□=91 → □=3. When numbers are close, <b>reverse fill</b> solves it in a flash!',
               zh:'91-88=？→88+□=91→□=3。两数接近时，<b>反向填空</b>一瞬间就解决了！' },
        mathSteps:['91 - 88 = □',{ko:'반대로: 88 + □ = 91',en:'\\text{backwards: } 88 + □ = 91',zh:'反过来：88 + □ = 91'},'□ = 3'],
