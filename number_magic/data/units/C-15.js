  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'③ 언제 이 마법을 쓸까?',en:'3) When to use this magic',zh:'③ 什么时候用这个魔法？'},
        ...
        book:{ko:'뒤 과정에서는 11×11, 111×111처럼 반복 숫자끼리 곱하면 파스칼의 삼각형을 닮은 피라미드 모양 숫자가 나온다는 걸 배워요.',
              en:'In a later course you\'ll see that multiplying two repeated-digit numbers (11×11, 111×111…) makes a pyramid-shaped number that mirrors Pascal\'s triangle.',
              zh:'在后面的课程中会学到，两个重复数字的数相乘（11×11、111×111……）会出现像帕斯卡三角形一样的金字塔形数字。'} }
    ],
