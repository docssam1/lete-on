...
window.NM_UNITS['M-08'] = {
  id:'M-08', tier:'middle1', level:'31', order:14,
  lineage:['ten-friends'],
  generator:'md8_terminating',
  title:{ ko:'유한소수 판별', en:'Terminating or Repeating?', zh:'判断有限小数' },
  subtitle:{ ko:'분모 속 2와 5만 있으면 끝나는 소수, 다른 수가 숨어 있으면 영원히 반복됩니다', en:'Only 2s and 5s in the denominator? It ends. Any other prime hiding there? It repeats forever', zh:'分母只有2和5就会结束，藏着别的质因数就会永远循环' },
  icon:'♾️',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'유한은 "세다 보면 끝이 있다", 무한은 "끝이 없다"입니다. 그럼 소수점 아래는요? 0.375는 끝나는데 1/3=0.333…은 왜 안 끝날까요?',
      ...
      history:{ ko:'무한대 기호 ∞는 1655년 월리스가 처음 썼습니다. 소수의 유한·무한도 같은 질문입니다 — 분모를 뜯어보면 답이 미리 보입니다.',
    ...
    stages:[
      { tag:{ko:'① 분모가 2와 5뿐이면 유한소수',en:'1) Only 2s and 5s — it terminates',zh:'① 分母只有2和5——有限小数'},
        ...
        desc:{ko:'8=2×2×2, 소인수가 <b>2뿐</b>입니다. 분모를 2와 5의 곱으로 부풀려 10의 거듭제곱으로 만들 수 있으면(8×125=1000) 소수는 반드시 어딘가에서 끝나요: 3/8=375/1000=<b>0.375</b>.',
        ...
        result:{ko:'분모 속 소인수가 2와 5뿐이면 항상 유한소수입니다!',en:'If the denominator\'s only prime factors are 2 and 5, it always terminates!',zh:'分母的质因数只有2和5，就一定是有限小数！'},
        book:null },
      ...
      { tag:{ko:'② 다른 소인수가 있으면 순환소수',en:'2) Any other prime factor — it repeats',zh:'② 有别的质因数——循环小数'},
        ...
        desc:{ko:'3은 2도 5도 아닙니다. 아무리 10을 곱해도 3으로 딱 나누어떨어지지 않아서, 나눗셈이 <b>절대 끝나지 않고</b> 같은 나머지가 반복됩니다 — 그래서 순환소수(무한소수)가 됩니다. <b>먼저 기약분수로 만드는 것</b>이 중요해요: 6/8도 8이 아니라 약분한 3/4의 분모(=2²)를 봐야 합니다.',
        ...
        result:{ko:'2와 5가 아닌 소인수가 하나라도 남으면 영원히 반복됩니다!',en:'Even one leftover prime factor other than 2 and 5 makes it repeat forever!',zh:'只要留下一个不是2或5的质因数，就会永远循环！'},
        book:{ko:'이건 "2와 5는 친구" 계보의 마지막 걸음입니다 — 보수 10을 만들던 2×5가 이제는 유한소수인지 아닌지를 판정하는 열쇠가 됐습니다.',
  ...
  check:{
    fills:[
      ...
      { tex:{ko:'\\dfrac{5}{12} \\;\\Rightarrow\\; \\square\\,(1=\\text{유한},0=\\text{순환})',en:'\\dfrac{5}{12} \\;\\Rightarrow\\; \\square\\,(1=\\text{terminating},0=\\text{repeating})',zh:'\\dfrac{5}{12} \\;\\Rightarrow\\; \\square\\,(1=\\text{有限},0=\\text{循环})'}, answer:0,
        hint:{ ko:'12=2×2×3, 3이 숨어 있습니다', en:'12=2×2×3, a 3 is hiding', zh:'12=2×2×3，藏着一个3' } }
    ],
    open:{ ko:'6/15는 유한소수일까요? 먼저 약분부터 해봅니다.',
  ...
  arena:{
    ...
    params:{level:'unreduced'},
    rule:{ ko:'5분 안에 유한소수인지 판별을 모두 마칩니다!', en:'Decide terminating or not for every problem in 5 minutes!', zh:'5分钟内判断完所有题目！' }
  },
