  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 100 근처: 앞자리+뒷자리',en:'1) Near 100: front + back',zh:'① 接近100：前面+后面'},
        ...
        mathSteps:['104 = 100+4',{ko:'104+4 = 108 (앞자리)',en:'104+4 = 108 \\text{ (front part)}',zh:'104+4 = 108（前段）'},{ko:'4² = 16 (뒷자리)',en:'4² = 16 \\text{ (back part)}',zh:'4² = 16（后段）'},'108×100+16 = 10816'],
      ...
      { tag:{ko:'② 50과 1000 근처는?',en:'2) What about near 50 and 1000?',zh:'② 接近50和1000呢？'},
        ...
        mathSteps:['54=50+4',{ko:'25+4=29 (앞자리)',en:'25+4=29 \\text{ (front part)}',zh:'25+4=29（前段）'},{ko:'4²=16 (뒷자리)',en:'4²=16 \\text{ (back part)}',zh:'4²=16（后段）'},'29×100+16 = 2916'],
