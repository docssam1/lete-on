  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 빼는 수를 □0으로 만들어요', en:'1) Make the subtrahend a round ten', zh:'① 把减数变成整十数' },
        ...
        desc:{ ko:'53-38=? 에서 38+2=40으로 맞추면 빼기 쉬워져요. <b>53에도 2를 더해</b> 55-40=15. 바로 답!',
               en:'53-38=? If 38+2=40, subtraction is easy. <b>Add 2 to 53 too</b>: 55-40=15. Done!',
               zh:'53-38=？如果38+2=40，减法就简单了。<b>53也加2</b>：55-40=15。搞定！' },
      ...
      { tag:{ ko:'② 더해야 할 수 d 찾기', en:'2) Find d to add', zh:'② 找到要加的数d' },
        ...
        desc:{ ko:'<b>일의 자리가 8이면 d=2</b> (8+2=10). 일의 자리가 7이면 d=3 (7+3=10). 간단!',
               en:'<b>Ones digit 8 → d=2</b> (8+2=10). Ones digit 7 → d=3. Simple!',
               zh:'<b>个位是8→d=2</b>（8+2=10）。个位是7→d=3。简单！' },
