...
window.NM_UNITS['A-05'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 100의 짝이란?', en:'1) What are 100-pairs?', zh:'① 什么是凑百配对？' },
        ...
        mathSteps:[{ko:'25 + 75 = 100  (짝!)',en:'25 + 75 = 100 \\text{ (a pair!)}',zh:'25 + 75 = 100（凑对！）'}, {ko:'40 + 60 = 100  (짝!)',en:'40 + 60 = 100 \\text{ (a pair!)}',zh:'40 + 60 = 100（凑对！）'}, {ko:'63 + 37 = 100  (짝!)',en:'63 + 37 = 100 \\text{ (a pair!)}',zh:'63 + 37 = 100（凑对！）'}],
      ...
      { tag:{ ko:'② 짝을 찾아 먼저 더해요', en:'2) Find pairs, add them first', zh:'② 找出配对先相加' },
        ...
        mathSteps:['25 + 54 + 75 + 46',{ko:'= (25 + 75) + (54 + 46)  ← 짝끼리!',en:'= (25 + 75) + (54 + 46) ← \\text{pairs together!}',zh:'= (25 + 75) + (54 + 46) ← 配对在一起！'},'= 100 + 100','= 200'],
      ...
      { tag:{ ko:'③ 100이 하나뿐이어도 괜찮아요', en:'3) Even one 100-pair helps!', zh:'③ 只有一组凑百配对也没关系！' },
        ...
        mathSteps:['48 + 52 + 37',{ko:'= (48 + 52) + 37  ← 짝 먼저!',en:'= (48 + 52) + 37 ← \\text{pair first!}',zh:'= (48 + 52) + 37 ← 先算配对！'},'= 100 + 37','= 137'],
  ...
  check:{
    fills:[
      ...
      { tex:'35 + 63 + 65 + 37 = \\square + \\square', answer:[100,100],
