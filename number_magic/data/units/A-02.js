  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 수는 나뉘어 있어요',en:'1) Numbers are made of parts',zh:'① 数字是拼出来的'},
        ...
        desc:{ko:'7은 1과 6, 또는 2와 5, 또는 3과 4가 모인 것이기도 해요. <b>어떻게 나누느냐가 마법의 열쇠</b>예요.',
              en:'7 is also 1+6, or 2+5, or 3+4. <b>How you split it is the key</b> to the magic.',
              zh:'7也可以是1+6，或者2+5，或者3+4。<b>怎么拆开，就是魔法的关键</b>。'},
      ...
      { tag:{ko:'② 부족한 만큼 이사시켜요',en:'2) Move just enough',zh:'② 搬过去刚好的量'},
        ...
        desc:{ko:'8은 10이 되려면 2가 더 필요해요. 그래서 <b>7에서 2만 이사 오면</b>, 8은 10이 되고 7은 5만 남아요.',
              en:'8 needs 2 more to become 10. So we <b>move 2 from the 7</b> — now 8 becomes 10, and 7 has 5 left.',
              zh:'8要变成10还差2。所以<b>从7那里搬2过来</b>——8变成10，7剩下5。'},
      ...
      { tag:{ko:'③ 어떤 수를 옮겨도 답은 같아요',en:'3) Either direction works',zh:'③ 从哪边搬都一样'},
        ...
        desc:{ko:'9는 10이 되려면 1이 필요해요. 6에서 1만 이사 오면 9는 10, 6은 5가 남아요. <b>어느 쪽에서 옮기든 결과는 같아요</b>.',
              en:'9 needs 1 more to become 10. Move 1 from the 6 — 9 becomes 10, 6 has 5 left. <b>Either direction gives the same answer</b>.',
              zh:'9要变10还差1。从6那里搬1过来——9变10，6剩5。<b>不管从哪边搬，结果都一样</b>。'},
