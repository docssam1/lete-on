  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 빼지는 수를 □0으로 낮춰요', en:'1) Round the minuend down to a multiple of 10', zh:'① 把被减数降到整十数' },
        ...
        desc:{ ko:'62-28=? 에서 62-2=60으로 맞추면 계산이 쉬워요. <b>28에서도 2를 빼서 26으로</b>. 60-26=34!',
               en:'62-28=? If 62-2=60, calculation is easy. <b>Subtract 2 from 28 too</b>: 26. 60-26=34!',
               zh:'62-28=？如果62-2=60，计算就简单了。<b>28也减2变26</b>。60-26=34！' },
        mathSteps:['62 - 28 = □',{ko:'62의 일의 자리 2 → d = 2',en:'\\text{ones digit of 62 is 2} → d = 2',zh:'62的个位是2 → d = 2'},'62-2=60, 28-2=26','60 - 26 = 34'],
      ...
      { tag:{ ko:'② 이전 전략(더해서 빼기)와 차이점', en:'2) How is this different from "Add Same to Both"?', zh:'② 与"同加"策略有什么不同？' },
        ...
        desc:{ ko:'A-20(더해서 빼기): 빼는 수(B)를 □0으로 올림. A-21(빼서 빼기): 빼지는 수(A)를 □0으로 낮춤. <b>어느 쪽이 더 편한지 골라요</b>!',
               en:'A-20: rounds the subtrahend (B) UP to □0. A-21: rounds the minuend (A) DOWN to □0. <b>Pick whichever is easier!</b>',
               zh:'A-20：把减数(B)向上凑到整十数。A-21：把被减数(A)向下降到整十数。<b>选哪个方便用哪个</b>！' },
        mathSteps:['75 - 38 = □',{ko:'방법1: 38+2=40, 75+2=77, 77-40=37',en:'\\text{method 1: } 38+2=40, 75+2=77, 77-40=37',zh:'方法1：38+2=40, 75+2=77, 77-40=37'},{ko:'방법2: 75-5=70, 38-5=33, 70-33=37',en:'\\text{method 2: } 75-5=70, 38-5=33, 70-33=37',zh:'方法2：75-5=70, 38-5=33, 70-33=37'}],
