...
window.NM_UNITS['M-22'] = {
  ...
  practice:{
    ...
    params:{mode:'basic'},
    intro:{
      ko:'(x+2)³을 하나하나 세 번 곱하지 않아도, 계수 패턴 3a, 3a², a³만 알면 바로 답이 나옵니다!',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'(x+2)²는 x²+4x+4로 이미 압니다. 그럼 한 번 더 곱한 (x+2)³은요? 매번 괄호를 세 번 곱해 펼치기엔 너무 번거롭습니다 — 패턴이 있지 않을까요?',
      ...
      history:{ ko:'세제곱 공식은 이차식 곱셈공식의 자연스러운 확장입니다. 괄호를 하나씩 분배해서 곱하는 원리 자체는 변하지 않고, 계수만 "1, 3, 3, 1"이라는 규칙적인 패턴으로 나타납니다.',
    ...
    stages:[
      { tag:{ko:'① (x+a)³ = x³+3ax²+3a²x+a³',en:'1) (x+a)³ = x³+3ax²+3a²x+a³',zh:'① (x+a)³ = x³+3ax²+3a²x+a³'},
        ...
        desc:{ko:'a=2일 때 3a=6, 3a²=12, a³=8 — 계수 자리에 그대로 넣으면 <b>x³+6x²+12x+8</b>이 됩니다. (x+2)²=x²+4x+4에 (x+2)를 한 번 더 곱해도 같은 결과가 나옵니다.',
        ...
        book:{ko:'(x+a)³=x³+3ax²+3a²x+a³, (x-a)³=x³-3ax²+3a²x-a³ — a의 부호를 그대로 대입하면 둘 다 같은 공식입니다.',
      ...
      { tag:{ko:'② 합·차의 세제곱 공식',en:'2) Sum/difference of cubes',zh:'② 立方和差公式'},
        ...
        desc:{ko:'(x+2)(x²-2x+4)를 직접 펼쳐 보면 가운데 항들이 모두 사라지고 <b>x³+8</b>만 남습니다. x³-a³도 부호만 바뀐 짝꿍 공식입니다.',
        ...
        result:{ko:'세제곱의 합·차는 이 짝꿍 인수분해로 정리됩니다!',en:'A sum or difference of cubes always resolves into this factored pair!',zh:'立方和或立方差总能化成这一对因式！'},
        book:{ko:'x³+a³=(x+a)(x²-ax+a²), x³-a³=(x-a)(x²+ax+a²) — 부호가 앞뒤로 엇갈립니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 합·차의 세제곱 공식을 모두 확인합니다!', en:'Confirm all the sum/difference-of-cubes formulas in 5 minutes!', zh:'5分钟内确认所有立方和差公式！' }
  },
