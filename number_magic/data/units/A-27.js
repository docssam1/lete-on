...
window.NM_UNITS['A-27'] = {
  ...
  subtitle:{ ko:'a부터 b까지 자연수는 b-a+1개예요', en:'Integers from a to b: there are b−a+1 of them', zh:'从a到b的整数个数是b-a+1' },
  icon:'🔢',

  practice:{
    generator:'countBetween', level:'practice', count:5,
    intro:{ ko:'시작부터 끝까지 자연수 개수를 세는 연습이에요!', en:'Practice counting integers from start to end!', zh:'练习从头到尾数整数的个数！' }
  },
  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 세어서 확인해봐요', en:'1) Check by counting', zh:'① 数一数验证' },
        ...
        desc:{ ko:'3부터 7까지 자연수: 3, 4, 5, 6, 7 → 5개. 7-3+1=5! <b>공식이 맞아요</b>.',
      ...
      { tag:{ ko:'② 큰 수에서도 공식이 편해요', en:'2) Formula works for big ranges too', zh:'② 大范围也能用公式' },
        ...
        desc:{ ko:'15부터 63까지 자연수는 몇 개? 63-15+1=49개! 직접 세면 힘들지요?',
  ...
  check:{
    ...
    open:{ ko:'a부터 b까지 자연수의 개수가 b-a+1인 이유를 설명해봐요.', en:'Explain why the count of integers from a to b is b−a+1.', zh:'说说为什么从a到b的整数个数是b-a+1。' },
