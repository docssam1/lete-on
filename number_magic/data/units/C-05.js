  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 가우스의 발견',en:'1) Gauss\'s discovery',zh:'① 高斯的发现'},
        ...
        mathSteps:['1+100=101','2+99=101',{ko:'... 50쌍 ...',en:'... \\text{50 pairs} ...',zh:'... 50对 ...'},'101 × 50 = 5050'],
      ...
      { tag:{ko:'② 가우스 방법 직접 해보기',en:'2) Trying the Gauss method',zh:'② 亲试高斯方法'},
        ...
        mathSteps:[{ko:'쌍의 합 = 1+10 = 11',en:'\\text{sum of a pair} = 1+10 = 11',zh:'每对的和 = 1+10 = 11'},{ko:'쌍의 수 = 10÷2 = 5',en:'\\text{number of pairs} = 10÷2 = 5',zh:'对数 = 10÷2 = 5'},{ko:'합계 = 11 × 5 = 55',en:'\\text{total} = 11 × 5 = 55',zh:'总和 = 11 × 5 = 55'}],
      ...
      { tag:{ko:'③ 공식 적용하기',en:'3) Applying the formula',zh:'③ 应用公式'},
        ...
        book:{ko:'뒤 과정에서는 이 짝짓기 셈을 제곱 공식으로 한 번 더 변신시켜요: (끝²−첫²+첫+끝)÷2. 세 자리 수열까지도 순식간에!',
              en:'In a later course this pairing trick transforms once more into a square formula: (last²−first²+first+last)÷2 — instant sums even for three-digit sequences!',
              zh:'在后面的课程中，这个配对法会再变身成平方公式：(末²−首²+首+末)÷2，连三位数数列也能瞬间求和！'} }
    ],
