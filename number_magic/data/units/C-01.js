  ...
  discover:{
    ...
    stages:[
      ...
      { tag:{ko:'③ 제곱수의 패턴',en:'3) Patterns in square numbers',zh:'③ 平方数的规律'},
        ...
        book:{ko:'뒤 과정(제곱의 언덕)에서는 이 패턴을 공식으로 써요: ★²=(★−1)²+(★−1)+★. 옆 제곱수만 알면 못 외운 제곱수도 바로 구할 수 있어요. 1로 끝나는 수(61²=60²+60+61)도 같은 원리예요.',
              en:'A later course (Hill of Squares) turns this pattern into a formula: n²=(n−1)²+(n−1)+n — know one neighbouring square and any square you haven\'t memorised follows instantly. Numbers ending in 1 (61²=60²+60+61) use the same idea.',
              zh:'后面的课程(平方之丘)把这个规律写成公式：★²=(★−1)²+(★−1)+★——只要知道相邻的平方数，没背过的平方数也能立刻求出。尾数是1的数（61²=60²+60+61）也是同样的原理。'} }
    ],
