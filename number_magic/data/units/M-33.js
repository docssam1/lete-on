...
window.NM_UNITS['M-33'] = {
  ...
  subtitle:{ ko:'기울기는 y변화÷x변화, y절편은 한 점을 대입해 찾습니다', en:'Slope is Δy÷Δx; find the y-intercept by substituting one point', zh:'斜率是Δy÷Δx，代入一点求y轴截距' },
  icon:'📈',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'좌표평면 위 두 점을 지나는 직선을 y=ax+b 꼴의 식으로 쓰고 싶습니다. 두 점만 알면 기울기와 y절편을 다 찾을 수 있을까요?',
      ...
      history:{ ko:'기울기는 "x가 1만큼 늘 때 y가 얼마나 느는가"를 뜻합니다. 두 점 사이의 y변화량을 x변화량으로 나누면 이 비율이 그대로 나오고, 거기에 한 점을 대입하면 y절편까지 완성됩니다.',
    ...
    stages:[
      { tag:{ko:'① 기울기 = y변화÷x변화',en:'1) Slope = Δy÷Δx',zh:'① 斜率 = y变化÷x变化'},
        ...
        desc:{ko:'x가 1에서 3으로(변화량 2), y가 3에서 7로(변화량 4) 늘었습니다. 기울기 a=4÷2=<b>2</b> — x가 1 늘 때마다 y는 2씩 늘어납니다.',
        ...
        result:{ko:'기울기는 y의 변화량을 x의 변화량으로 나눈 값입니다!',en:'Slope is the change in y divided by the change in x!',zh:'斜率是y的变化量除以x的变化量！'},
        book:{ko:'a=(y₂-y₁)/(x₂-x₁) — 어느 점을 앞뒤로 놓아도 값은 같습니다.',
      ...
      { tag:{ko:'② 일반형 → 기울기절편형',en:'2) General form → slope-intercept form',zh:'② 一般式→斜截式'},
        ...
        desc:{ko:'y항만 남기고 2x를 우변으로 이항하면 y=<b>-2x+6</b>. 부호가 바뀌는 걸 잊지 마세요 — 이항의 기본 규칙 그대로입니다.',
        ...
        result:{ko:'y항만 남기고 나머지를 이항하면 기울기절편형이 됩니다!',en:'Isolate the y term and transpose the rest to get slope-intercept form!',zh:'只留y项、移走其余的，就变成斜截式！'},
        book:{ko:'Ax+By=C(B≠0)는 y=(-A/B)x+(C/B)로 바뀝니다 — By만 남기고 나머지를 이항한 뒤 B로 나눈 것과 같습니다.',
  ...
  check:{
    ...
    open:{ ko:'A(-1,4), B(2,-2)를 지나는 직선의 방정식을 구하는 과정을 설명해봅니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 더 큰 범위의 일반형 변환을 모두 풉니다!', en:'Solve all the wider-range general-form conversions in 5 minutes!', zh:'5分钟内解答所有更大范围的一般式转换！' }
  },
