  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 9는 10에서 살짝 모자라요',en:'1) 9 is just short of 10',zh:'① 9只比10少一点'},
        ...
        desc:{ko:'9는 10보다 딱 1이 작아요. 그래서 9를 더할 땐 우선 <b>10을 통째로 주고, 나중에 1을 돌려받으면</b> 돼요.',
              en:'9 is exactly 1 short of 10. So when adding 9, <b>give a full 10 first, then take 1 back later</b>.',
              zh:'9正好比10少1。所以加9的时候，<b>先整个给10，之后再要回1</b>就行。'},
        mathSteps:['9 = 10 - 1'],
      ...
      { tag:{ko:'② 우선 10을 다 주고 봐요',en:'2) Give the full 10 first',zh:'② 先给足10'},
        ...
        desc:{ko:'25에 9를 그냥 더하면 헷갈리기 쉬워요. 대신 25에 10을 먼저 주고, <b>1을 더 준 걸 알아채고 돌려받아요</b>.',
              en:'Adding 9 to 25 directly is easy to mess up. Instead, give 25 a full 10 first, then <b>notice we overgave 1 and take it back</b>.',
              zh:'直接给25加9容易出错。不如先给25加满10，再<b>发现多给了1，把它拿回来</b>。'},
      ...
      { tag:{ko:'③ 8이나 7을 더할 때도 똑같아요',en:'3) Works for 8 and 7 too',zh:'③ 加8或7也一样'},
        ...
        desc:{ko:'8은 10보다 2가 작으니, 10을 주고 2를 돌려받으면 돼요. 어떤 수를 더하든 "<b>10을 주고 남는 걸 빼기</b>"는 똑같아요.',
              en:'8 is 2 short of 10, so give 10 and take back 2. No matter the number, "<b>give 10 then subtract the extra</b>" always works.',
              zh:'8比10少2，所以给10再拿回2。不管加几，"<b>先给10再减多给的</b>"都一样管用。'},
