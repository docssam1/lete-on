...
window.NM_UNITS['M-06'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ko:'① 곱셈·나눗셈이 항상 먼저',en:'1) × and ÷ always come first',zh:'① 乘除永远优先'},
        ...
        desc:{ko:'덧셈보다 <b>곱셈을 먼저</b> 계산해요: 3×(−4)=−12. 그다음 −5+(−12)=<b>−17</b>. 부호가 섞여 있어도 "곱셈·나눗셈 먼저"라는 순서 규칙은 똑같이 적용됩니다.',
        ...
        result:{ko:'부호가 있어도 순서 규칙은 흔들리지 않습니다!',en:'Signs never shake the order rule!',zh:'有符号也不会动摇顺序规则！'},
        book:null },

      { tag:{ko:'② 괄호는 그보다 더 먼저',en:'2) Brackets come before even that',zh:'② 括号比乘除更优先'},
        head:{ko:'(−4+7) × (−2) − 5 = −11',en:'(−4+7) × (−2) − 5 = −11',zh:'(−4+7) × (−2) − 5 = −11'},
        desc:{ko:'가장 먼저 <b>괄호 안</b>을 계산해요: −4+7=3. 그다음 곱셈: 3×(−2)=−6. 마지막에 뺄셈: −6−5=<b>−11</b>. "괄호 → 곱나눗 → 덧뺄"의 순서를 지키면 아무리 복잡해도 헷갈리지 않습니다.',
        ...
        result:{ko:'순서만 지키면 부호가 있는 사칙 혼합도 두렵지 않습니다!',en:'Keep the order and signed mixed operations stop being scary!',zh:'守住顺序，带符号的四则混合运算也不可怕！'},
        book:{ko:'나눗셈이 섞여 있어도 곱셈과 같은 우선순위입니다 — 곱셈·나눗셈끼리는 앞에서부터 차례로 계산합니다.',
  ...
  check:{
    ...
    open:{ ko:'−10 + 6 ÷ (−2)를 순서에 맞춰 계산해봅니다.',
  ...
  arena:{
    ...
    rule:{ ko:'5분 안에 나눗셈이 섞인 혼합 계산을 모두 풉니다!', en:'Solve all mixed operations with division in 5 minutes!', zh:'5分钟内解答所有含除法的混合运算！' }
  },
