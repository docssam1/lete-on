...
window.NM_UNITS['A-31'] = {
  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 받아내림 없는 자리부터 빼요', en:'1) Subtract borrow-free digits first', zh:'① 先减不需要借位的那位' },
        ...
        mathSteps:['74 - 36 = □','십의 자리(쉬운 부분): 70-30=40','40 + 4 - 6 = 40 - 2 = 38'],
      ...
      { tag:{ ko:'② 세 자리 수에서도 적용해요', en:'2) Works for 3-digit numbers too', zh:'② 三位数也适用' },
        ...
        mathSteps:['852 - 427 = □','800-400=400, 50-20=30 (쉬운 부분 먼저)','400 + 30 = 430','430 + 2 - 7 = 425'],
  ...
  check:{
    fills:[
      { tex:'74-36: 70-30=\\square \\text{(쉬운 부분)}', answer:40,
