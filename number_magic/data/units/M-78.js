...
window.NM_UNITS['M-78'] = {
  ...
  subtitle:{ ko:'가장 단순한 포물선, 꼭짓점이 원점입니다', en:'The simplest parabola, with its vertex at the origin', zh:'最简单的抛物线，顶点在原点' },
  icon:'🥣',

  practice:{
    generator:'md78_quadBasic', level:'practice', count:5,
    params:{mode:'value'},
    intro:{ ko:'x를 먼저 제곱한 다음 a를 곱해 보세요 — 제곱하면 음수도 양수가 됩니다!', en:'Square x first, then multiply by a - squaring turns a negative positive!', zh:'先把x平方，再乘以a——平方后负数也变正！' }
  },

  discover:{
    title:{ ko:'누미의 마법 노트', en:"Numi's Magic Note", zh:'努米的魔法笔记' },
    story:{
      hook:{ ko:'y=x²의 표를 만들어 보면 x가 −3, −2, −1, 0, 1, 2, 3일 때 y는 9, 4, 1, 0, 1, 4, 9입니다. <b>−3과 3이 같은 y를 줍니다</b> — 제곱하면 부호가 사라지기 때문입니다. 그래서 그래프가 y축을 거울 삼아 좌우가 똑같고, 가장 낮은 곳이 원점 하나입니다. 일차함수가 곧은 직선이었던 것과 달리, 제곱 하나가 들어오자 그림이 휩니다.', en:'Tabulate y=x2 and for x = -3, -2, -1, 0, 1, 2, 3 you get y = 9, 4, 1, 0, 1, 4, 9. <b>-3 and 3 give the same y</b>, because squaring throws the sign away. So the graph mirrors itself across the y-axis and has a single lowest point at the origin. Where a linear function drew a straight line, one square bends the picture.', zh:'列出y=x²的表：x为−3、−2、−1、0、1、2、3时，y是9、4、1、0、1、4、9。<b>−3和3给出相同的y</b>，因为平方把符号丢掉了。所以图象以y轴为镜左右相同，最低点只有原点一个。一次函数画的是直线，加了一个平方，图就弯了。' },
      history:{ ko:'포물선(parabola)이라는 이름은 기원전 3세기 아폴로니오스가 붙였습니다. 원뿔을 비스듬히 자른 단면 가운데 하나였죠. 순수한 기하학 놀이처럼 보였던 이 곡선이, 1900년 뒤 갈릴레이가 던진 물체의 길이 바로 그 곡선임을 밝히면서 세상을 설명하는 도구가 됐습니다.', en:'The name parabola was given by Apollonius in the third century BCE, for one of the curves you get by slicing a cone at a slant. What looked like pure geometry became a tool for describing the world nineteen centuries later, when Galileo showed that a thrown object traces exactly that curve.', zh:'抛物线(parabola)这个名字是公元前3世纪阿波罗尼奥斯起的，是斜切圆锥得到的曲线之一。这条看似纯几何游戏的曲线，1900年后被伽利略证明正是抛出物体的轨迹，从此成了解释世界的工具。' }
    },
    stages:[
    ...
    rule:{ ko:'제곱이 먼저, a를 곱하는 것이 나중 — a의 부호가 볼록한 방향을, 크기가 폭을 정합니다!', en:'Square first and multiply by a second - the sign of a decides which way it opens and the size decides how narrow it is!', zh:'先平方再乘a——a的符号决定开口方向，大小决定宽窄！' }
  },
  ...
  lab:{
    ...
    params:{mode:'findA'},
    intro:{ ko:'y를 x의 제곱으로 나누면 a가 나옵니다!', en:'Divide y by x squared to get a!', zh:'用y除以x的平方就得到a！' }
  },

  arena:{
    generator:'md78_quadBasic', level:'main', count:8, timeLimit:360,
    params:{mode:'readA'},
    rule:{ ko:'6분 안에 그래프에서 지나는 점을 읽어 a를 구합니다!', en:'Within 6 minutes, read a point off the graph and work out a!', zh:'6分钟内从图象上读出一个点并求出a！' }
  },
