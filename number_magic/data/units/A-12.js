  ...
  discover:{
    ...
    stages:[
      { tag:{ ko:'① 더하기 뺴기가 섞여 있을 때', en:'1) When plus and minus mix', zh:'① 加减混在一起时' },
        ...
        desc:{ ko:'35-14+21-22처럼 더하기와 빼기가 섞여 있으면, 더하는 수(35, 21)끼리 먼저 더하고, 빼는 수(14, 22)끼리 먼저 더한 다음, 마지막에 <b>큰 합에서 작은 합을 빼요</b>.',
               en:'For 35-14+21-22, add the plus-terms (35, 21) together, add the minus-terms (14, 22) together, then <b>subtract the second sum from the first</b>.',
               zh:'像35-14+21-22这样加减混合，先把加数(35、21)加起来，减数(14、22)加起来，<b>再用前者减后者</b>。' },
      ...
      { tag:{ ko:'② 수가 더 많아져도 똑같아요', en:'2) Works with more terms too', zh:'② 数再多也一样' },
        ...
        desc:{ ko:'수가 많아져도 걱정 없어요. <b>더하는 수는 모두 한쪽으로, 빼는 수는 모두 다른 쪽으로</b> 모아서 각각 더한 다음 빼주면 돼요.',
               en:'Even with more numbers, just <b>gather all the plus-terms on one side and all the minus-terms on the other</b>, add each group, then subtract.',
               zh:'数再多也不怕，<b>把所有加数放一边，减数放另一边</b>，各自相加后再相减。' },
      ...
      { tag:{ ko:'③ 앞에서부터 계산이 안 될 때 특히 좋아요', en:'3) Especially good when order-by-order gets stuck', zh:'③ 从前往后算不通时特别好用' },
        ...
        desc:{ ko:'27-53+72-15을 앞에서부터 차례로 계산하면 27에서 53을 뺄 수 없어 막혀요. 하지만 <b>더하는 수끼리, 빼는 수끼리 묶으면</b> 문제없이 풀 수 있어요.',
               en:'Calculating 27-53+72-15 step by step gets stuck since 27 is smaller than 53. But <b>grouping plus-terms and minus-terms</b> solves it easily.',
               zh:'按顺序计算27-53+72-15会卡住，因为27减不了53。但<b>用归类法</b>就能顺利算出。' },
