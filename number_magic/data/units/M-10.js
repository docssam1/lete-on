...
window.NM_UNITS['M-10'] = {
  ...
  practice:{
    ...
    params:{mode:'mul'},
    intro:{
      ko:'2³은 2를 3번 곱한 거입니다. 2³×2⁴는 2를 모두 몇 번 곱한 걸까?',
  ...
  discover:{
    ...
    story:{
      hook:{ ko:'2를 10번 곱한 수를 그냥 쓰면 1024입니다. 근데 2를 100번 곱하면? 그걸 매번 다 쓰긴 너무 귀찮습니다 — 더 짧게 쓸 방법 없을까요?',
      ...
      history:{ ko:'거듭제곱 표기 aⁿ은 17세기 수학자 데카르트가 널리 퍼뜨렸습니다. 그전엔 학자마다 제각각 표기를 썼는데, "곱한 횟수를 어깨 위에 작게 적는" 이 방법이 결국 표준이 됐습니다.',
    ...
    stages:[
      { tag:{ko:'① 곱셈은 지수를 더하기',en:'1) Multiplying means adding exponents',zh:'① 相乘就是指数相加'},
        ...
        desc:{ko:'a³은 a를 3번, a⁴는 a를 4번 곱한 거입니다. 둘을 곱하면 a를 <b>3+4=7번</b> 곱한 셈이니 a⁷이 됩니다. 밑(a)이 같을 때만 이 규칙을 씁니다 — 밑이 다르면 지수를 더할 수 없습니다.',
        ...
        result:{ko:'밑이 같은 거듭제곱의 곱셈은 지수를 더합니다!',en:'Multiplying same-base powers: add the exponents!',zh:'同底数幂相乘：指数相加！'},
        book:{ko:'같은 문자(밑)의 거듭제곱끼리 곱할 때 aᵐ×aⁿ=aᵐ⁺ⁿ이 성립합니다.',
      ...
      { tag:{ko:'② 거듭제곱의 거듭제곱은 지수끼리 곱하기',en:'2) A power of a power multiplies the exponents',zh:'② 幂的乘方是指数相乘'},
        ...
        desc:{ko:'(a²)³은 a²를 3번 곱하는 거입니다 — a²×a²×a² = a^{2+2+2} = a⁶. 결국 2와 3을 <b>곱한</b> 것과 같습니다. 나눗셈(aᵐ÷aⁿ)은 반대로 지수를 뺍니다 — 곱한 걸 다시 나누니까 당연합니다.',
        ...
        result:{ko:'거듭제곱을 다시 거듭제곱하면 지수끼리 곱해요, 나누면 지수끼리 뺍니다!',en:'A power of a power multiplies the exponents; dividing subtracts them!',zh:'幂的乘方指数相乘，幂的相除指数相减！'},
        book:{ko:'(aᵐ)ⁿ=aᵐⁿ, aᵐ÷aⁿ=aᵐ⁻ⁿ(m>n)입니다. 세 법칙이 한 식에 섞이면 안쪽 괄호부터 하나씩 정리합니다.',
      ...
      { tag:{ko:'③ 그런데 왜 0제곱은 1일까? -1제곱은?',en:'3) But why is the zeroth power 1? And the -1st?',zh:'③ 那为什么0次方是1？-1次方呢？'},
        ...
        desc:{ko:'사다리를 한 칸씩 내려가 보면 저절로 답이 나옵니다. 2³=8, 2²=4, 2¹=2 — 지수가 1 줄 때마다 <b>÷2</b>가 되죠? 그 규칙을 멈추지 않고 한 칸 더 내려가면 2⁰=2÷2=<b>1</b>, 또 한 칸 내려가면 2⁻¹=1÷2=<b>1/2</b>. 0제곱이 1인 건 약속이 아니라 <b>사다리의 규칙이 시켜서</b>입니다. 어떤 수든 같아요: 5⁰=1, 100⁰=1.',
        ...
        result:{ko:'사다리를 내려가면 0제곱=1, -1제곱=역수 — 규칙이 스스로 알려줍니다!',en:'Walk down the ladder: the 0th power is 1, the -1st is the reciprocal — the rule tells you itself!',zh:'沿梯子往下走：0次方=1，-1次方=倒数——规则自己告诉你！'},
        book:{ko:'a⁰=1(a≠0), a⁻ⁿ=1/aⁿ. 나눗셈 법칙 aᵐ÷aᵐ=aᵐ⁻ᵐ=a⁰이 1이 되는 것과도 딱 맞습니다(같은 수끼리 나누면 1이니까).',
  ...
  lab:{
    ...
    params:{mode:'pow'},
    intro:{
      ko:'거듭제곱의 거듭제곱! 지수끼리 곱하면 바로 나옵니다.',
  ...
  arena:{
    ...
    params:{mode:'combo'},
    rule:{ ko:'5분 안에 지수법칙이 섞인 문제를 모두 풉니다!', en:'Solve all the mixed exponent-law problems in 5 minutes!', zh:'5分钟内解答所有混合指数法则的题目！' }
  },
