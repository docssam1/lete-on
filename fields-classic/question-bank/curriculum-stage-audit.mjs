...
assert(curriculumTypeIds.size === 433, `expected 433 curriculum types, got ${curriculumTypeIds.size}`);
assert(detailedTypeCount === 480, `expected 480 detailed types, got ${detailedTypeCount}`);
assert(detailedReferenceCount === 901, `expected 901 detailed references, got ${detailedReferenceCount}`);
