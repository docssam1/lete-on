...
assert(curriculumTypeIds.size === 442, `expected 442 curriculum types, got ${curriculumTypeIds.size}`);
assert(detailedTypeCount === 489, `expected 489 detailed types, got ${detailedTypeCount}`);
assert(detailedReferenceCount === 913, `expected 913 detailed references, got ${detailedReferenceCount}`);
