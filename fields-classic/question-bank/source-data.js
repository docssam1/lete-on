...
export const TYPES = [
  ...
  type("calendar-date-weekday", "pattern", "달력과 시간", "달력에서 특정 날짜의 요일 찾기", { generator: "calendarDateWeekday", sourceMatched: true }),
  ...
  type("five-card-sum-pyramid", "number", "수 배열과 합", "다섯 수 카드로 9 가르기 피라미드"),
  ...
  type("repeat-four-shapes", "pattern", "반복 규칙", "네 가지 도형의 순서 반복"),
  ...
  type("equal-line-sum-eight-cards", "number", "수 배열과 합", "1부터 8까지 한 번씩 써서 줄의 합 만들기"),
  ...
  type("shape-equation-add-subtract", "number", "복면산과 식", "더하기와 빼기로 도형 수 구하기"),
  type("two-digit-condition", "number", "조건에 맞는 수", "조건에 맞는 두 자리 수", { generator: "sourceTwoDigitSumDifference", sourceMatched: true }),
  type("two-digit-parity-gap", "number", "조건에 맞는 수", "짝수와 자릿수 차 조건의 두 자리 수"),
  type("growing-shape-count", "pattern", "도형 규칙", "구슬 배열의 개수 규칙", { generator: "sourceGrowingDotSquare", sourceMatched: true }),
  type("triangle-tile-growth", "pattern", "도형 규칙", "정삼각형 조각 수의 성장 규칙"),
  type("square-tile-growth", "pattern", "도형 규칙", "정사각형 조각 수의 성장 규칙"),
  ...
  type("fold-cut-piece-count", "geometry", "색종이 접기", "접고 자른 조각의 개수", { generator: "foldCutPieceCount", sourceMatched: true }),
  ...
  type("fold-diagonal-number-sum", "geometry", "색종이 접기", "대각선으로 접은 수 색종이에서 자른 부분의 합", { generator: "foldDiagonalNumberSum", sourceMatched: true }),
  type("fold-target-sum-coloring", "geometry", "색종이 접기", "목표 합이 되도록 접은 색종이 자를 부분 색칠하기", { generator: "foldTargetSumColoring", sourceMatched: true }),
  type("fold-punch-shape-count", "geometry", "색종이 접기", "접어서 뚫은 반원·원 모양의 개수", { generator: "foldPunchShapeCount", sourceMatched: true }),
  type("fold-stack-find", "geometry", "색종이 접기", "겹친 색종이 중 가장 밑(또는 위)에 있는 것 찾기", { generator: "foldStackFind", sourceMatched: true }),
  type("fold-stack-order", "geometry", "색종이 접기", "겹친 색종이를 위에서부터 순서대로 쓰기", { generator: "foldStackOrder", sourceMatched: true }),
  type("fold-cut-shape-choice", "geometry", "색종이 접기", "접어 자르고 펼친 모양 고르기", { generator: "foldCutShapeChoice", sourceMatched: true }),
  ...
  type("fold-number-remaining-sum", "geometry", "색종이 접기", "번호 색종이를 접고 자른 뒤 남은 수의 합", { generator: "foldNumberRemainingSum", sourceMatched: true }),
...
export const CURRICULUM = [
  { id: "book-01", label: "1권", title: "도형 움직이기와 마방진", units: [unit("도형 움직이기",["shape-transform"]),unit("색종이 접기",["fold-hole-count","fold-diagonal-hole-count","fold-diagonal-unfold","fold-cut-piece-count","fold-number-remaining-sum","fold-number-cut-sum","fold-diagonal-number-sum","fold-target-sum-coloring","fold-stack-find","fold-stack-order","fold-punch-shape-count","fold-cut-shape-choice"]),unit("마방진과 가쿠로 퍼즐",["magic-square","gakuro"]),unit("수 추리와 논리 추리",["grid-number-placement","person-item-logic"])] },
