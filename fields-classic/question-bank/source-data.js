...
export const TYPES = [
  ...
  type("fold-number-cut-sum", "geometry", "색종이 접기", "번호 색종이를 접고 자른 수의 합", { generator: "foldNumberCutSum", sourceMatched: true, textbookSource: "더클래식 1과정 1권 41·50쪽" }),
  ...
  type("fold-hole-count", "geometry", "색종이 접기", "접은 색종이의 구멍 개수", { generator: "paperFoldHoleCount", legacyId: 4, sourceMatched: true, textbookSource: "더클래식 1과정 1권 40·42쪽" }),
  ...
  type("fold-diagonal-number-sum", "geometry", "색종이 접기", "대각선으로 접은 수 색종이에서 자른 부분의 합", { generator: "foldDiagonalNumberSum", sourceMatched: true, textbookSource: "필즈 실전 1회 18번·2회 15번 구조" }),
  type("fold-target-sum-coloring", "geometry", "색종이 접기", "목표 합이 되도록 접은 색종이 자를 부분 색칠하기", { generator: "foldTargetSumColoring", sourceMatched: true, textbookSource: "수 색종이 자르기의 역방향(색칠 답)" }),
  type("fold-punch-shape-count", "geometry", "색종이 접기", "접어서 뚫은 반원·원 모양의 개수", { generator: "foldPunchShapeCount", sourceMatched: true, textbookSource: "더클래식 1과정 1권 51쪽 연습12" }),
