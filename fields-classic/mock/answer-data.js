...
window.FIELDS_MOCK_ANSWERS = {
  "final-2": {
    ...
    questions: [
      ...
      {"no":16,"summary":"주변 삼각형 합에 맞게 1~5 배치","domain":"수와 연산","middle":"수 배열과 합","type":"행·열 합에 맞게 1부터 차례로 놓기","typeId":"row-column-sum-placement","diff":"중","answer":"위 1, 2 / 아래 5, 3, 4","note":"열 합 5·4·6, 행 합 3·12를 모두 만족"},
