...
| **rp·ws·sl 유사 지문 어휘 미사용** | 상 | **미착수.** 19세트의 newPassage가 그 레슨의 12개 어휘를 다 안 쓴다(ws3=11개 누락·sl16=10개·ws6=10개가 최악, sl2·sl5·sl6·sl10·sl11은 1개). STEP6~7이 어휘를 재노출하는 자리인데 지문이 어휘와 무관하면 그 역할을 못 한다. 지문 재작성 필요 — 기계적 보정 불가 |
