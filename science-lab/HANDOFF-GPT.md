...
## 2. 읽는 순서 (저장소 안)
1. **이 문서**
2. `science-lab/HANDOFF-18.md` (18차 결정: 종이 첨삭·B2B·제미나이). `HANDOFF.md`의 17차 위로 합쳐야 한다.
3. `science-lab/HANDOFF.md` (1~17차 전체 기록과 "⚠ 새 세션은 여기부터" 절)
4. `science-lab/DESIGN.md` (5E 설계) → `data/source-toc.md` (단원 축과 원천 교재 매핑) → `UX-TEST-2026-09-19.md`
5. 저장소 루트 `CLAUDE.md`의 "과학 탐구 랩" 절 (저장소 전체 규칙: 원문 분리, 검사기, 음성 캐시)
