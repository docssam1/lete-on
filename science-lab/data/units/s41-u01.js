...
const T = (topic, concept, inquirySkill, itemType, level) =>
  ({ domain: '운동과 에너지', course: '4-1', unit: 'u01', topic, concept, inquirySkill, itemType, level });
...
export const items = [
  ...
  // ── single-choice 10 (정답 위치 사전 배분: ③①⑤②④②⑤①③④ → 각 2회) ──
  ...
  choice(10, T('자석의 극', '자석을 잘라도 조각마다 두 극이 생긴다', 'prediction with stated conditions', 'single-choice', 3),
  ...
  choice(13, T('자석의 극', '양 끝과 가운데를 대어 보면 자석을 가릴 수 있다', 'evidence-based conclusion', 'single-choice', 3),
  ...
  choice(15, T('자석의 힘', '바꾸는 조건과 같게 할 조건', 'manipulated, responding, and controlled variables', 'single-choice', 3),
  ...
  written(18, T('자석이 가리키는 방향', '극 표시 없는 자석의 극 찾기', 'experiment purpose or hypothesis', 'written-explanation', 3),
  ...
  written(20, T('자석의 힘', '자석 세기 비교 실험 설계', 'manipulated, responding, and controlled variables', 'written-explanation', 3),
