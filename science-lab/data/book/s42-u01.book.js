...
export const chapter = {
  ...
  labTitle: '연못에 식물 심고 부레옥잠 눌러 보기',
  selfLink: '실험 결과를 연못·강가에서 본 식물과 이어 생각했나요?',
  summary: ['부레옥잠의 볼록한 <b>잎자루</b> 속 <b>공기주머니</b> 덕분에 물에 떠서 살아요.', '물에 사는 식물은 <b>물에 떠서</b>·<b>잎이 떠서</b>·<b>물속에 잠겨서</b>·<b>물가</b>에서 살아요.', '식물은 사는 곳의 환경에 알맞은 생김새로 <b>적응</b>해 왔어요.'],
  ...
  rail: {
    ...
    6: [{ h: '실험과 잇기', t: '공기가 든 볼록한 잎자루처럼, 물 위에서 살기에 알맞은 생김새를 갖게 된 것이 적응이에요.' }, { g: ['환경', '적응'] }],
