...
window.VIDEO_PLAN = {
  ...
  week: {
    ...
    note: {
      ko: '이번 주는 우리 둘레 세상을 주제로 명작 이야기·수학·동물·자연을 배워요. 하루에 영상 2개를 보고 퀴즈 4개를 모두 맞히면 포인트를 받아요!',
      en: 'This week explores the world around us — great stories, math, animals, and nature. Watch 2 videos a day and pass all 4 quiz questions to earn points!',
      zh: '本周主题是我们周围的世界 — 名作故事、数学、动物和自然。每天看 2 个视频并答对 4 道题就能获得积分！',
    },
  },
  sections: [
    { key: 'reading', emoji: '✨', color: '#7a5cc3', name: { ko: '명작 이야기', en: 'Great Stories', zh: '名作故事' }, playlist: 'G-FIELD Reading Town | Great Stories' },
  ...
  days: [
    { key: 'mon', name: { ko: '월', en: 'Mon', zh: '周一' }, focus: { ko: '명작 이야기 + 수학', en: 'Great Stories + Math', zh: '名作故事 + 数学' }, videos: ['v-mon-1', 'v-mon-2'] },
    ...
    { key: 'fri', name: { ko: '금', en: 'Fri', zh: '周五' }, focus: { ko: '수학 + 명작 이야기', en: 'Math + Great Stories', zh: '数学 + 名作故事' }, videos: ['v-fri-1', 'v-fri-2'] },
    { key: 'sat', name: { ko: '토', en: 'Sat', zh: '周六' }, focus: { ko: '좋아하는 영상', en: 'Favorites', zh: '最爱视频' }, videos: ['v-sat-1', 'v-sat-2'] },
  ],
  videos: {
    'v-mon-1': {
      section: 'reading', channel: 'Storyline Online', minutes: 10, search: 'Storyline Online Enemy Pie Camryn Manheim', id: 'b_I9NgXKtC8',
      title: { ko: '에너미 파이 (Enemy Pie)', en: 'Enemy Pie', zh: '敌人派' },
      keyWords: [{ en: 'enemy', ko: '적' }, { en: 'friend', ko: '친구' }, { en: 'recipe', ko: '요리법(비법)' }],
      summary: { ko: '완벽했던 여름, 새로 이사 온 제레미가 최고의 “적”이 됐어요. 아빠는 적을 없애는 비법 “에너미 파이”를 알려줬는데, 비법은 하루 동안 그 아이와 사이좋게 노는 거였어요. 둘은 친구가 됐어요!', en: 'One summer a new boy, Jeremy, becomes the narrator’s number-one enemy. Dad shares a secret recipe — “Enemy Pie” — but the trick is to spend a whole day playing nicely with your enemy. They end up as friends!', zh: '一个夏天，新搬来的杰里米成了“头号敌人”。爸爸分享了对付敌人的秘方“敌人派”，可秘诀却是要和敌人友好地玩一整天。最后他们成了朋友！' },
      quiz: [
        { strat: 'Main Idea', q: { ko: '이 이야기가 주는 가장 큰 가르침은?', en: 'What is the big lesson of this story?', zh: '这个故事最大的道理是？' }, choices: ['An enemy can become a friend', 'Pie is the best food', 'Never share anything', 'Always stay angry'], answer: 0, hint: { ko: '적이었던 아이와 친구가 됐어요.', en: 'The enemy turned into a friend.', zh: '敌人变成了朋友。' } },
        { strat: 'Inference', q: { ko: '“에너미 파이”의 진짜 비법은 무엇이었을까요?', en: 'What was the real secret of “Enemy Pie”?', zh: '“敌人派”真正的秘诀是什么？' }, choices: ['Spend a kind day together', 'Bake a scary pie', 'Yell at the enemy', 'Hide all day'], answer: 0, hint: { ko: '하루 동안 친절하게 함께 노는 거였어요.', en: 'It was spending a kind day playing together.', zh: '是友好地一起玩一整天。' } },
        { strat: 'Sequence', q: { ko: '두 아이는 언제 친구가 되었나요?', en: 'When did the two boys become friends?', zh: '两个男孩什么时候成了朋友？' }, choices: ['After a day together', 'Before they ever met', 'They never did', 'Only at bedtime'], answer: 0, hint: { ko: '함께 하루를 보낸 뒤예요.', en: 'After they spent the day together.', zh: '在一起玩了一天之后。' } },
        { strat: 'Feeling', q: { ko: '처음에 아이는 제레미에게 어떤 기분이었나요?', en: 'How did the narrator feel about Jeremy at first?', zh: '一开始“我”对杰里米什么感觉？' }, choices: ['Annoyed', 'Delighted', 'Sleepy', 'Proud'], answer: 0, hint: { ko: '제레미가 미워서 “적”이라고 했어요.', en: 'He disliked him — his number-one enemy.', zh: '他讨厌他，把他当头号敌人。' } },
      ],
    },
    'v-mon-2': {
    ...
    'v-fri-2': {
      section: 'reading', channel: 'Storyline Online', minutes: 11, search: 'Storyline Online Somebody Loves You Mr Hatch Hector Elizondo', id: 'AGAS_Aj85cA',
      title: { ko: '누군가 당신을 사랑해요, 해치 아저씨', en: 'Somebody Loves You, Mr. Hatch', zh: '有人爱你，哈奇先生' },
      keyWords: [{ en: 'lonely', ko: '외로운' }, { en: 'kindness', ko: '친절' }, { en: 'neighbor', ko: '이웃' }],
      summary: { ko: '조용하고 외로운 해치 아저씨에게 “누군가 당신을 사랑해요”라는 쪽지가 왔어요. 아저씨는 밝아져서 이웃에게 친절을 베풀었어요. 쪽지가 실수였다는 걸 알고 슬퍼졌지만, 이웃들이 깜짝 파티로 사랑을 보여줬어요!', en: 'Quiet, lonely Mr. Hatch gets a note that says “Somebody loves you.” He brightens up and starts being kind to his neighbors. When he learns the note came by mistake he grows sad — but his neighbors throw a surprise party to show they truly love him!', zh: '安静又孤独的哈奇先生收到一张写着“有人爱你”的纸条。他变得开朗，开始对邻居友善。当他得知纸条是送错了，他难过起来——但邻居们办了惊喜派对，向他表达真心的爱！' },
      quiz: [
        { strat: 'Feeling', q: { ko: '쪽지를 받기 전, 해치 아저씨는 어떤 기분이었나요?', en: 'How did Mr. Hatch feel before the note arrived?', zh: '收到纸条前，哈奇先生感觉如何？' }, choices: ['Lonely', 'Excited', 'Angry', 'Silly'], answer: 0, hint: { ko: '늘 혼자여서 외로웠어요.', en: 'He was always alone and lonely.', zh: '他总是独自一人，很孤独。' } },
        { strat: 'Cause & Effect', q: { ko: '“누군가 당신을 사랑해요” 쪽지를 받고 아저씨는 어떻게 변했나요?', en: 'After the “Somebody loves you” note, how did he change?', zh: '收到“有人爱你”的纸条后，他有什么变化？' }, choices: ['Happy and kind', 'Meaner', 'Sleepier', 'Quieter'], answer: 0, hint: { ko: '밝아져서 이웃에게 친절을 베풀었어요.', en: 'He grew cheerful and kind to neighbors.', zh: '他变得开朗，对邻居友善。' } },
        { strat: 'Inference', q: { ko: '이웃들이 깜짝 파티를 연 이유는 무엇일까요?', en: 'Why did the neighbors throw him a surprise party?', zh: '邻居们为什么给他办惊喜派对？' }, choices: ['They really do love him', 'They were bored', 'To sell candy', 'To say goodbye'], answer: 0, hint: { ko: '아저씨를 정말 사랑하기 때문이에요.', en: 'Because they truly love him.', zh: '因为他们真心爱他。' } },
        { strat: 'Main Idea', q: { ko: '이 이야기가 알려주는 것은?', en: 'What does this story teach us?', zh: '这个故事告诉我们什么？' }, choices: ['We are loved by those around us', 'Candy is bad', 'Stay alone', 'Never smile'], answer: 0, hint: { ko: '우리는 이웃에게 사랑받고 있어요.', en: 'We are loved by the people around us.', zh: '我们被身边的人所爱。' } },
      ],
    },
    'v-sat-1': {
