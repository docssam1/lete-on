...
window.VIDEO_PLAN = {
  ...
  videos: {
    ...
    'v-tue-1': {
      section: 'animal', channel: 'Nat Geo Kids', minutes: 20, search: 'Nat Geo Kids ocean animals', id: '', playlist: 'PLQlnTldJs0ZQNDwnQlIStNF9LwoSAM7aF',
      title: { ko: '동물 대백과 (Amazing Animals)', en: 'Amazing Animals', zh: '动物大百科' },
      keyWords: [{ en: 'animal', ko: '동물' }, { en: 'amazing', ko: '놀라운' }, { en: 'bamboo', ko: '대나무' }],
      summary: { ko: '매 편 다른 동물을 소개하는 Nat Geo Kids 시리즈(87편)! 판다, 문어, 전갈… 신기한 동물을 이어서 만나요.', en: 'Nat Geo Kids "Amazing Animals" profiles a different animal each episode (87 of them)! Meet pandas, octopuses, scorpions and more.', zh: 'Nat Geo Kids “动物大百科”每集介绍一种动物（共87集）！' },
      quiz: [
        ...
        { strat: 'Detail', q: { ko: '판다는 주로 무엇을 먹을까요?', en: 'What do pandas mostly eat?', zh: '熊猫主要吃什么？' }, choices: ['Bamboo', 'Fish', 'Pizza', 'Grass only'], answer: 0, hint: { ko: '초록색 대나무를 좋아해요.', en: 'They love green bamboo.', zh: '它们爱吃绿色的竹子。' } },
        { strat: 'Detail', q: { ko: '아기 판다가 좋아하는 것은?', en: 'What do baby pandas like to do?', zh: '熊猫宝宝喜欢做什么？' }, choices: ['Somersaults', 'Fly a plane', 'Read books', 'Drive cars'], answer: 0, hint: { ko: '데굴데굴 앞구르기를 좋아해요.', en: 'They like to tumble and do somersaults.', zh: '它们喜欢翻跟头。' } },
        { strat: 'Word Meaning', q: { ko: '아기 곰(판다)을 영어로 뭐라고 할까요?', en: 'What is a baby panda called?', zh: '熊猫宝宝英语怎么说？' }, choices: ['A cub', 'A puppy', 'A chick', 'A calf'], answer: 0, hint: { ko: '곰의 새끼는 “cub”이에요.', en: 'A baby bear is a “cub”.', zh: '熊宝宝叫 “cub”。' } },
      ],
    },
    'v-tue-2': {
      section: 'animal', channel: 'Nat Geo Kids', minutes: 20, search: 'Nat Geo Kids weird but true ocean coral reef', id: '', playlist: 'PLQlnTldJs0ZQNDwnQlIStNF9LwoSAM7aF',
      title: { ko: '동물 대백과 · 신기한 동물', en: 'Amazing Animals · Weird & True', zh: '动物大百科 · 奇趣动物' },
    ...
    'v-thu-1': {
      section: 'science', channel: 'Nat Geo Kids', minutes: 8, search: 'Nat Geo Kids Wonder List stars clouds', id: '', playlist: 'PLQlnTldJs0ZQM6zWf-D4sEYYG2Qh576Qu',
      title: { ko: '원더 리스트 · 별과 구름', en: 'The Wonder List · Stars & Clouds', zh: '奇妙清单 · 星星与云' },
      keyWords: [{ en: 'star', ko: '별' }, { en: 'cloud', ko: '구름' }, { en: 'sky', ko: '하늘' }],
      summary: { ko: 'Nat Geo Kids “The Wonder List” — 우리 둘레의 자연(별·구름·나무·바위)을 알려주는 시리즈예요. 밤하늘의 별과 구름을 살펴봐요!', en: 'Nat Geo Kids "The Wonder List" explores the world around you — stars, clouds, trees, and rocks. Look up at the stars and clouds!', zh: 'Nat Geo Kids “奇妙清单”带你认识身边的自然：星星、云、树和石头！' },
      quiz: [
        { strat: 'Detail', q: { ko: '별은 어디에서 볼 수 있나요?', en: 'Where do we see stars?', zh: '我们在哪里看到星星？' }, choices: ['In the night sky', 'Under the ground', 'In the fridge', 'In a book'], answer: 0, hint: { ko: '밤하늘을 올려다봐요.', en: 'Look up at the night sky.', zh: '抬头看夜空。' } },
        ...
        { strat: 'Main Idea', q: { ko: '“The Wonder List”는 우리에게 무엇을 하게 하나요?', en: 'What does “The Wonder List” help us do?', zh: '“奇妙清单”让我们做什么？' }, choices: ['Notice the world around us', 'Only play games', 'Only cook', 'Only sleep'], answer: 0, hint: { ko: '둘레의 자연을 자세히 살펴봐요.', en: 'Notice the wonderful world around us.', zh: '留意身边奇妙的世界。' } },
      ],
    },
    'v-thu-2': {
      section: 'science', channel: 'Nat Geo Kids', minutes: 8, search: 'Nat Geo Kids Wonder List trees rocks', id: '', playlist: 'PLQlnTldJs0ZQM6zWf-D4sEYYG2Qh576Qu',
      title: { ko: '원더 리스트 · 나무와 바위', en: 'The Wonder List · Trees & Rocks', zh: '奇妙清单 · 树与石头' },
      keyWords: [{ en: 'tree', ko: '나무' }, { en: 'rock', ko: '바위' }, { en: 'nature', ko: '자연' }],
      summary: { ko: '나무는 우리에게 맑은 공기를 줘요. 바위는 단단하고 아주 오래됐어요. 자연을 자세히 살펴봐요!', en: 'Trees give us fresh air, and rocks are hard and very old. Look closely at nature!', zh: '树给我们新鲜空气，石头坚硬又古老。仔细观察大自然！' },
      quiz: [
    ...
    'v-sat-1': {
      section: 'animal', channel: 'Nat Geo Kids', minutes: 20, search: 'Nat Geo Kids weird but true ocean wonders', id: '', playlist: 'PLQlnTldJs0ZQNDwnQlIStNF9LwoSAM7aF',
      title: { ko: '동물 대백과 · 좋아하는 동물', en: 'Amazing Animals · Favorites', zh: '动物大百科 · 最爱' },
      ...
      quiz: [
        ...
        { strat: 'Main Idea', q: { ko: '이 시리즈는 무엇에 대한 것인가요?', en: 'What is this series about?', zh: '这个系列讲什么？' }, choices: ['Amazing animals', 'How to draw', 'Space rockets', 'Cooking'], answer: 0, hint: { ko: '놀라운 동물들이에요.', en: 'Amazing animals.', zh: '神奇的动物。' } },
      ],
    },
    'v-sat-2': {
