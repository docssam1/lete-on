// Lesson 1 shared (non-licensed) content: words, created passages and created questions.
...
window.LESSON1={
 ...
 "words": [
  [
   "zoo",
   "a place where people can see animals",
   "동물원"
  ],
  [
   "squirrels",
   "small animals with long, bushy tails",
   "다람쥐들"
  ],
  [
   "robins",
  ...
  [
   "crickets",
   "small insects that make chirping sounds",
   "귀뚜라미들"
  ],
  [
   "chipmunks",
   "small striped animals like squirrels",
   "줄다람쥐들"
  ],
  [
   "moths",
   "insects that fly at night",
   "나방들"
  ],
  [
   "fireflies",
   "small insects that make light at night",
   "반딧불이들"
  ],
  [
   "skunks",
   "small animals with a strong smell",
   "스컹크들"
  ],
  [
   "free",
 ...
 "learnPassage": [
  "Mae has a small zoo right outside her house. She does not need a ticket because her zoo is free. She smiles and says, “I am not pulling your leg!”",
  "In the daytime, Mae sees squirrels jump from branch to branch. Small chipmunks run near the garden. Crickets hide in the grass and make their tiny sounds.",
  "At night, moths come near the porch light. Fireflies blink in the dark. Once, Mae saw a skunk walking slowly by the fence, so she watched quietly.",
