...
function town(){
 ...
 const header=`<div class="town-top"><div class="town-brand">Gfield Reading Town</div><div class="town-tools">${chip}<span class="points-pill">★ ${pts}P</span>${noticeBtn}${parentBtn}<div class="language-toggle town-lang">${langBtns}</div></div></div>`;
