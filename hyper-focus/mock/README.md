...
- q10~q40은 기존 `같게` variation을 보존하면서 실제 `쉽게·같게·어렵게` 동적 생성기를 추가
- q41~q54는 기존 canonical·variation을 보존하고 검수된 `같게` 2문항을 사용
...
- q01~q40은 세 난이도 생성 지원, q41~q54 정적 variation 유형은 현재 검수된 `같게` 2문항만 노출
- A4 문제지·정답·진단지 인쇄
