...
- q10~q54는 기존 `같게` variation을 보존하면서 실제 `쉽게·같게·어렵게` 동적 생성기를 추가
...
- q01~q54 전체 유형이 세 난이도 생성을 지원하며 기존 var01·var02 데이터도 보존
- A4 문제지·정답·진단지 인쇄
...
- `../generator/applications.js`: q48~q54 일·비례·길이·저울·홀짝 생성기
