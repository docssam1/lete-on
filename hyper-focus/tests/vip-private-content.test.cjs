...
const externalMigration = read("supabase/migrations/20260910191549_vip_external_links_and_import.sql");
...
assert.match(externalMigration, /external_url/);
assert.match(externalMigration, /\^https:\/\//);
...
assert.match(edge, /safeExternalUrl/);
