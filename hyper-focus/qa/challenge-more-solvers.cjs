...
function solve(p){switch(p.kind){
 ...
 case 'dice-target-bottom':case 'dice-visible-faces':{const step=(o,d)=>d==='N'?{top:o.south,bottom:o.north,north:o.top,south:o.bottom,east:o.east,west:o.west}:d==='S'?{top:o.north,bottom:o.south,north:o.bottom,south:o.top,east:o.east,west:o.west}:d==='E'?{top:o.west,bottom:o.east,north:o.north,south:o.south,east:o.top,west:o.bottom}:{top:o.east,bottom:o.west,north:o.north,south:o.south,east:o.bottom,west:o.top};const finish=p.route.reduce(step,p.startOrientation);return p.kind==='dice-visible-faces'?[finish.top,finish.south,finish.east]:finish.bottom;}
