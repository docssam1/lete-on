...
const zoneCopy = {
  ...
  en: {
    ...
    crystalPlaza: ["Geometry Lab", "Discover worksheets and challenges"], shapeGarden: ["Shape Garden", "Rotate pieces and find matching shapes"]
  }
};
const districtCopy = {
  ko: {
