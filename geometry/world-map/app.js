...
const items = [
  ...
  { id: "helmet", category: "hat", iconId: "cat-helmet", cost: 220, name: { ko: "안전 헬멣", zh: "安全帽", ja: "ヘルメット", en: "Builder Helmet" } },
  { id: "wizard-hat", category: "hat", iconId: "cat-wizard", cost: 320, name: { ko: "마법사 모자", zh: "魔法帽", ja: "魔法の帽子", en: "Wizard Hat" } },
  { id: "flower-crown", category: "hat", iconId: "cat-flower", cost: 280, name: { ko: "꿃 왕관", zh: "花冠", ja: "花かんむり", en: "Flower Crown" } },
  ...
  { id: "snow", category: "aura", iconId: "cat-snow", cost: 250, name: { ko: "눈꿃 효과", zh: "雪花特效", ja: "雪エフェクト", en: "Snow Glow" } },
