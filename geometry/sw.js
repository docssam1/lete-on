...
const CORE = [
  ...
  "/geometry/games/soma-cube/styles.css?v=soma-3",
  "/geometry/games/soma-cube/app.js?v=soma-4",
  "/geometry/games/soma-cube/levels.js?v=soma-2",
  "/geometry/games/soma-cube/i18n.js?v=soma-3",
