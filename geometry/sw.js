...
const CORE = [
  ...
  "/geometry/solid-vista/app.js?v=solid-studio-4",
  ...
  "/geometry/games/net-observatory/styles.css?v=net-4",
  "/geometry/games/net-observatory/app.js?v=net-4",
  "/geometry/games/net-observatory/levels.js?v=net-4",
  "/geometry/games/net-observatory/i18n.js?v=net-4",
  "/geometry/games/net-observatory/fold-view.js?v=net-4",
  ...
  "/geometry/games/dice-roll/app.js?v=dice-roll-8",
  "/geometry/games/dice-roll/levels.js?v=dice-roll-3",
  "/geometry/games/dice-roll/route-scene.js?v=dice-roll-2",
