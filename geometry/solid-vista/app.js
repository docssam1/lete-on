...
const copy = {
  ko: { district:"공간·입체 지구",title:"전개도를 접고 조각을 맞춰 입체의 비밀을 찾아요",subtitle:"평면에서 시작해 주사위, 정다면체, 소마큐브까지 차례로 탐험해요.",net:"전개도 전망대",desc:"면이 접이는 순서와 서로 마주 보는 관계를 관찰해요.",session:"단계마다 10문제 · 한 번에 5문제",start:"시작하기",soma:"소마큐브 공방",somaDesc:"일곱 조각을 여러 방향으로 돌려 목표 입체를 완성해요." },
  en: { district:"Spatial Solids District",title:"Fold nets and assemble pieces to uncover solid geometry",subtitle:"Travel from flat patterns to dice, regular solids, and Soma cubes.",net:"Net Observatory",desc:"Watch faces fold and discover how they meet.",session:"10 per stage · 5 each session",start:"Start",soma:"Soma Cube Workshop",somaDesc:"Turn seven pieces in space to build target solids." },
  zh: { district:"空间立体区",title:"折叠展开图、组合拼块，发现立体的秘密",subtitle:"从平面图形逐步探索骰子、正多面体和索玛立方。",net:"展开图瞭望台",desc:"观察各面折叠的顺序和相对关系。",session:"每阶段10题 · 每次5题",start:"开始",soma:"索玛立方工坊",somaDesc:"旋转七个拼块，完成目标立体。" },
  ja: { district:"空間・立体エリア",title:"展開図を折り、ピースを組んで立体の秘密を探ろう",subtitle:"平面からサイコロ、正多面体、ソーマキューブへ進みます。",net:"展開図展望台",desc:"面が折れる順番と向かい合う関係を観察します。",session:"各段階10問 · 1回5問",start:"スタート",soma:"ソーマキューブ工房",somaDesc:"7つのピースを回して目標の立体を完成します。" }
};
const levelNames = {
