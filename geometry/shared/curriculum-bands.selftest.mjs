...
assert.equal(Object.keys(activityBands["shape-transform"]).length, 5);
assert.deepEqual(Object.values(activityBands["shape-transform"]), ["facto1", "1031-intro-entry", "1031-intro-entry", "1031-basic", "1031-basic"]);
assert.equal(curriculumBands["1031-intro-entry"].ko, "1031 입문 · 입문");
assert.deepEqual(excludedConcepts, ["similarity"]);
...
console.log("Geometry curriculum bands passed: 3 bands, 15 mapped activities, similarity excluded; scaling allowed.");
