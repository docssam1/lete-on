const copy = {
  ...
  zh: {
    brand:"索玛立方工坊", level:"阶段", target:"目标形状", build:"我的作品", tray:"拼块托盘", hint:"提示", clear:"清空", skip:"下一题", levelPick:"选择阶段", pieces:"{done}/{total}块", rotateActions:["侧转","上转","翻转"],
  ...
  ja: {
    brand:"ソーマキューブ工房", level:"段階", target:"作る形", build:"自分の形", tray:"ピース置き場", hint:"ヒント", clear:"空にする", skip:"次の問題", levelPick:"段階を選ぼう", pieces:"{done}/{total}ピース", rotateActions:["横回転","上回転","裏返す"],
