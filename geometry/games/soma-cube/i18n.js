const copy = {
  ko: {
    ...
    hint:"힌트", clear:"비우기", skip:"다음 문제", levelPick:"단계를 골라요", pieces:"{done}/{total}조각",
    ...
    tutorial:["소마큐브는 서로 다른 일곱 조각으로 입체를 만드는 퍼즐이에요.","아래 조각을 고른 뒤 X·Y·Z 회전 버튼으로 방향을 바꿔요.","옅게 빛나는 자리를 누르면 조각이 놓여요. 놓은 조각을 누르면 다시 보관함으로 돌아와요."],
  ...
  en: {
    ...
    hint:"Hint", clear:"Clear", skip:"Next", levelPick:"Choose a stage", pieces:"{done}/{total} pieces",
    ...
    tutorial:["A Soma cube puzzle builds solids with seven different pieces.","Choose a piece below, then turn it with the X, Y, and Z buttons.","Tap a softly glowing valid place. Tap a placed piece to return it to the tray."],
