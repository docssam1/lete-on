...
assert.deepEqual(await page.locator('[data-view-tools="target"] [data-view]').allTextContents(), ["입체", "위", "앞", "옆", "자동"]);
await page.locator('[data-view-tools="target"] [data-view="top"]').click();
assert.equal(await page.locator('[data-view-tools="target"] [data-view="top"]').getAttribute("aria-pressed"), "true");
await page.locator('[data-view-tools="target"] [data-view="auto"]').click();
assert.equal(await page.locator('[data-view-tools="target"] [data-view="auto"]').getAttribute("aria-pressed"), "true");
await page.locator('[data-view-tools="target"] [data-view="iso"]').click();
assert.equal(await page.locator('[data-view-tools="target"] [data-view="iso"]').getAttribute("aria-pressed"), "true");
...
assert.match(await page.locator("#pieceStatus").textContent(), /1\/2조각 · \d+\/\d+칸/);
await page.locator("#hintButton").click();
await page.locator("#hintButton").click();
