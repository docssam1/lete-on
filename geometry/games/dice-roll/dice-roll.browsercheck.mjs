...
console.log(JSON.stringify({ level3Routes: 3, level5Choices: 3, sceneMetrics, pixelStdev: pixelStats.channels.map((channel) => channel.stdev), roll: { firstDirection, beforeRoll, afterRoll }, reducedMotion: { direction: reducedDirection, duration: reducedDuration }, flatHint: { nextDirection, usefulFace, manualFace }, mobile, diceCards: 5 }, null, 2));
await browser.close();
