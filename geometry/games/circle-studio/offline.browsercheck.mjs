...
try {
  ...
  for(const lang of ['ko','en','zh','ja'])for(const domain of gameDomains) {
  ...
  const report={passed:true,offlineDomains:3,languages:4,correctSubmissions:12,freshGardenInstallFirstGameEntry:true,scope:'Fresh context visits garden only before going offline; no game dependency warming',errors};
