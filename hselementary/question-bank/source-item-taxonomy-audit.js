...
check(sourceIds.size === 97, `원문 문항 ID는 97개여야 하나 ${sourceIds.size}개입니다.`);
check(reviewedTriangleIds.size === 32, "삼각형 공개 허용 원문은 32개여야 합니다.");
check(reviewedDecimalIds.size === 2, "소수 공개 허용 개념탐구는 2개여야 합니다.");
check(reviewedQuadrilateralIds.size === 9, "사각형 공개 허용 원문은 9개여야 합니다.");
...
console.log("원문 문항 단위 분류 감사 통과: 4-2 삼각형 44유형 + 소수 44유형 + 사각형 9유형 = 97개 고유 문항");
