...
- Total runtime types: 946 across 6 semesters, 36 major units, and 174 subunits
- Implemented types: 887 (deterministic runtime availability check)
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 887 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 887 public runtime types across 100 seeds per difficulty, including the source-mapped public types
- Numeric display policy: `numeric-display-audit.js` checks all 887 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
