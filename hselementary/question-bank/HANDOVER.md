...
- Implemented types: 601 (deterministic runtime availability check)
- Review-locked types: 313 (265 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 601 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks the generator-family catalog across 100 seeds per difficulty; the 64 public 4-1 mappings are a verified subset
