...
- Implemented types: 708 (deterministic runtime availability check)
- Review-locked types: 206 (158 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Grade 4-1 unit 3: 65 source items, 34 ready and 31 review-locked; multiplication exploration groups 1 and 2 and division exploration group 3 each have 11 source-native variants, one other exact-match generator remains active, and source example 6-4 does not exist
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 708 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 708 public runtime types across 100 seeds per difficulty, including all 171 public 4-1 mappings
- Numeric display policy: `numeric-display-audit.js` checks all 708 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
