...
- Grade 4-2 unit 2: triangles, all 44 source items mapped; 22 directly source-matched types ready and 22 locked for source-faithful rebuilding
...
- 4-2 triangle source routing, publication gate, and independent answer check: `triangle-4-2-audit.js` maps all 44 source items and permits only the 22 directly source-matched types to run
