...
- Implemented types: 885 (deterministic runtime availability check)
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 885 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 885 public runtime types across 100 seeds per difficulty, including the source-mapped public types
- Numeric display policy: `numeric-display-audit.js` checks all 885 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
