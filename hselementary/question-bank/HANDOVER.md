...
- Implemented types: 697 (deterministic runtime availability check)
- Review-locked types: 217 (169 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Grade 4-1 unit 3: 65 source items, 12 ready and 53 review-locked; multiplication exploration group 1 has 11 source-native variants, one other exact-match generator remains active, and source example 6-4 does not exist
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 697 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 697 public runtime types across 100 seeds per difficulty, including all 160 public 4-1 mappings
- Numeric display policy: `numeric-display-audit.js` checks all 697 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
