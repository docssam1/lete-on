...
- Implemented types: 675 (deterministic runtime availability check)
- Review-locked types: 239 (191 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Grade 4-1 unit 2: 66 source items, 53 ready and 13 review-locked; angle exploration groups 1 through 4 have all source-native variants, while group 5 publishes 9 independently verified items and keeps 2 ambiguous source items locked
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 675 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks the generator-family catalog across 100 seeds per difficulty; the 138 public 4-1 mappings are a verified subset
