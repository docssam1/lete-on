...
- Implemented types: 770 (deterministic runtime availability check)
- Review-locked types: 144 (96 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 770 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 770 public runtime types across 100 seeds per difficulty, including all 233 public 4-1 mappings
- Numeric display policy: `numeric-display-audit.js` checks all 770 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
