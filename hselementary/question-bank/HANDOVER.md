...
- Implemented types: 645 (deterministic runtime availability check)
- Review-locked types: 269 (221 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Grade 4-1 unit 2: 66 source items, 33 ready and 33 review-locked; angle exploration groups 1 through 3 have all source-native variants
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 645 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks the generator-family catalog across 100 seeds per difficulty; the 108 public 4-1 mappings are a verified subset
