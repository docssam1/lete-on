...
- Implemented types: 718 (deterministic runtime availability check)
- Review-locked types: 196 (148 source-inventoried 4-1 items plus 48 source-complex 4-2 items)
...
- Runtime availability policy: `runtime-availability-audit.js` checks all 718 public types across 20 seeds per difficulty
...
- Elementary explanation policy: `elementary-language-audit.js` checks all 718 public runtime types across 100 seeds per difficulty, including all 181 public 4-1 mappings
- Numeric display policy: `numeric-display-audit.js` checks all 718 public runtime types across 100 seeds per difficulty; the runtime sweep separately checks availability
