...
check(readiness.integrity.publicCandidateCount === 2 && readiness.integrity.lockedCount === 64 && readiness.integrity.allImplementationLocked === false, "6-2 1단원 검토표의 공개·잠금 요약이 다릅니다.");
