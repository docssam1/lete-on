...
check(readiness.integrity.publicCandidateCount === 5 && readiness.integrity.lockedCount === 61 && readiness.integrity.allImplementationLocked === false, "6-2 1단원 검토표의 공개·잠금 요약이 다릅니다.");
