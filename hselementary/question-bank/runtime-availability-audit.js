...
if (ready.length !== 886) failures.push(`생성 가능 유형은 886개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 58) failures.push(`검수 대기 유형은 58개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 944 · 생성 가능 886 · 검수 대기 58 · ${generatedCount.toLocaleString()}회 생성`);
