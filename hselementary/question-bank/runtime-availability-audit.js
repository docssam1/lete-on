...
if (ready.length !== 634) failures.push(`생성 가능 유형은 634개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 280) failures.push(`검수 대기 유형은 280개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 914 · 생성 가능 634 · 검수 대기 280 · ${generatedCount.toLocaleString()}회 생성`);
