...
if (ready.length !== 903) failures.push(`생성 가능 유형은 903개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 61) failures.push(`검수 대기 유형은 61개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 964 · 생성 가능 903 · 검수 대기 61 · ${generatedCount.toLocaleString()}회 생성`);
