...
if (ready.length !== 752) failures.push(`생성 가능 유형은 752개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 162) failures.push(`검수 대기 유형은 162개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 914 · 생성 가능 752 · 검수 대기 162 · ${generatedCount.toLocaleString()}회 생성`);
