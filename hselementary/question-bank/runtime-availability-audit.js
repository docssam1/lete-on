...
if (ready.length !== 874) failures.push(`생성 가능 유형은 874개여야 하나 ${ready.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 944 · 생성 가능 874 · 검수 대기 70 · ${generatedCount.toLocaleString()}회 생성`);
