...
if (ready.length !== 665) failures.push(`생성 가능 유형은 665개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 249) failures.push(`검수 대기 유형은 249개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 914 · 생성 가능 665 · 검수 대기 249 · ${generatedCount.toLocaleString()}회 생성`);
