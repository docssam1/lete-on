...
if (ready.length !== 675) failures.push(`생성 가능 유형은 675개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 239) failures.push(`검수 대기 유형은 239개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 914 · 생성 가능 675 · 검수 대기 239 · ${generatedCount.toLocaleString()}회 생성`);
