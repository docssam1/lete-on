...
if (ready.length !== 846) failures.push(`생성 가능 유형은 846개여야 하나 ${ready.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 914 · 생성 가능 846 · 검수 대기 68 · ${generatedCount.toLocaleString()}회 생성`);
