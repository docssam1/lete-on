...
if (ready.length !== 882) failures.push(`생성 가능 유형은 882개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 62) failures.push(`검수 대기 유형은 62개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 944 · 생성 가능 882 · 검수 대기 62 · ${generatedCount.toLocaleString()}회 생성`);
