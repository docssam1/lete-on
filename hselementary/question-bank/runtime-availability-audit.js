...
if (locked.length !== 155) failures.push(`검수 대기 유형은 155개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 1121 · 생성 가능 966 · 검수 대기 155 · ${generatedCount.toLocaleString()}회 생성`);
