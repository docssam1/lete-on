...
if (ready.length !== 858) failures.push(`생성 가능 유형은 858개여야 하나 ${ready.length}개입니다.`);
if (locked.length !== 86) failures.push(`검수 대기 유형은 86개여야 하나 ${locked.length}개입니다.`);
...
console.log(`런타임 생성 가능성 감사 통과: 전체 944 · 생성 가능 858 · 검수 대기 86 · ${generatedCount.toLocaleString()}회 생성`);
