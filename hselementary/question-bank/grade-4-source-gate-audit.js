...
const expected = {
  "4-1": {
    ...
    locked: 24,
    sourceLinked: 329,
    units: [[66, 66, 0, 66], [66, 63, 3, 66], [65, 65, 0, 65], [44, 35, 9, 44], [22, 18, 4, 22], [66, 58, 8, 66]]
  },
  "4-2": {
    total: 263,
    ready: 214,
    locked: 49,
    sourceLinked: 239,
    units: [[66, 66, 0, 66], [44, 41, 3, 44], [44, 35, 9, 44], [45, 19, 26, 21], [20, 18, 2, 20], [44, 35, 9, 44]]
  }
};
...
console.log(`4학년 원본 공개 문턱 감사 통과: 592유형 · 공개 519 · 검수 대기 73 · 원본 연결 568 · ${generatedCount.toLocaleString()}회 생성`);
