...
check(readiness.integrity.publicCandidateCount === 24 && readiness.integrity.lockedCount === 42 && readiness.integrity.calculationCheckedCount === 62 && readiness.integrity.calculationNeedsClarificationCount === 4 && readiness.integrity.singleAnswerTrueCount === 60 && readiness.integrity.singleAnswerFalseCount === 6, "6-2 1단원 검토표 요약이 실제 교정 결과와 다릅니다.");
