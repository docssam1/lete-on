...
check(readyCount === 32, `생성 가능 유형은 32개여야 하나 ${readyCount}개입니다.`);
check(lockedCount === 297, `검수 대기 유형은 297개여야 하나 ${lockedCount}개입니다.`);
...
console.log(`4-1 원문 기반 런타임 분류 감사 통과: 329유형 · 생성 가능 32 · 검수 대기 297 · ${generatedCount.toLocaleString()}회 생성`);
