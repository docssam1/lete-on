...
check(readyCount === 22, `생성 가능 유형은 22개여야 하나 ${readyCount}개입니다.`);
check(lockedCount === 307, `검수 대기 유형은 307개여야 하나 ${lockedCount}개입니다.`);
...
console.log(`4-1 원문 기반 런타임 분류 감사 통과: 329유형 · 생성 가능 22 · 검수 대기 307 · ${generatedCount.toLocaleString()}회 생성`);
