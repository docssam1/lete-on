...
check(readyCount === 128, `생성 가능 유형은 128개여야 하나 ${readyCount}개입니다.`);
check(lockedCount === 201, `검수 대기 유형은 201개여야 하나 ${lockedCount}개입니다.`);
...
console.log(`4-1 원문 기반 런타임 분류 감사 통과: 329유형 · 생성 가능 128 · 검수 대기 201 · ${generatedCount.toLocaleString()}회 생성`);
