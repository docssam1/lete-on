    ...
    semester("4-2", [
      ...
      ["꺾은선그래프",
        detailed("꺾은선그래프의 이해", "lineGraphUnderstanding", [
          ...
          {
            ...sourceItem42("눈금 사이 달의 판매 금액을 읽어 비교하기", 1, "4-2-u5-e1-mission-6", 53, 59, true),
            reviewReason: "9월 값이 그래프의 표시 점 사이에 있고 공식 답안이 없어 하나의 값으로 확정할 수 없습니다."
          }
        ]),
        detailed("꺾은선그래프의 활용", "lineGraphApplication", [
          { ...sourceItem42("두 학년의 키를 세로 눈금 사이에서 읽기", 0, "4-2-u5-e2-exploration", 54, 60, true), reviewReason: "세로 눈금의 중간값과 답을 원문 풀이로 다시 확인해야 합니다." },
          { ...sourceItem42("왕복하는 공의 시간별 위치 구하기", 0, "4-2-u5-e2-example-2-1", 54, 60, true), reviewReason: "왕복 주기와 시간 단위를 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("판매량 변화에 따라 다음 해 가격 구하기", 1, "4-2-u5-e2-example-2-2", 54, 60, true), reviewReason: "해마다 가격을 바꾸는 순서를 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("큰 수조와 작은 수조의 물의 양이 같아지는 때 구하기", 1, "4-2-u5-e2-example-2-3", 54, 60, true), reviewReason: "두 수조의 시작 조건과 기울기를 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("서로 다른 때부터 채운 두 물통의 높이 관계 구하기", 1, "4-2-u5-e2-example-2-4", 54, 60, true), reviewReason: "두 물통의 시작 시각과 높이 관계를 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("두 자동차의 이동 거리로 사용한 휘발유 차 구하기", 1, "4-2-u5-e2-mission-2", 55, 61, true), reviewReason: "그래프의 시간별 거리를 역산해 답을 다시 확인해야 합니다." },
          { ...sourceItem42("걷기와 뛰기를 바꾼 두 사람의 도착 시각 비교하기", 1, "4-2-u5-e2-mission-3", 55, 61, true), reviewReason: "걷기와 뛰기 구간의 기울기를 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("물을 받다 멈춘 뒤 더 세게 받은 전체 물의 양 구하기", 1, "4-2-u5-e2-mission-4", 55, 61, true), reviewReason: "구간별 물의 변화량과 마지막 값을 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("두 수도꼭지를 바꾸어 쓴 뒤 한 수도꼭지의 시간 구하기", 1, "4-2-u5-e2-mission-5", 55, 61, true), reviewReason: "수도꼭지별 사용량을 독립 검산하기 전까지 잠급니다." },
          { ...sourceItem42("연결된 두 그릇의 물이 차는 시각 차 구하기", 1, "4-2-u5-e2-mission-6", 55, 61, true), reviewReason: "두 그릇의 변화 시작 시각과 기울기를 독립 검산하기 전까지 잠급니다." }
        ])
      ],
      ["다각형",
