(() => {
  ...
  const semesters = [
    ...
    semester("5-1", [
      ...
      ["다각형의 둘레와 넓이", "다각형의 둘레", "직사각형과 정사각형의 넓이", "둘레와 넓이", "여러 가지 사각형의 넓이"]
    ]),
    semester("5-2", [
      ["수의 범위와 어림하기", "수의 범위", "어림하기", "어림하기의 활용", "어림한 수의 범위"],
      ["분수의 곱셈", "분수와 자연수의 곱셈", "분수끼리의 곱셈", "식 세워 풀기", "분수의 곱셈 응용 문제"],
      ["합동과 대칭", "조건에 맞는 삼각형 그리기", "삼각형의 결정 조건과 합동 조건", "합동의 활용 ①", "합동의 활용 ②", "선대칭도형", "선대칭의 활용", "점대칭도형", "점대칭의 활용"],
