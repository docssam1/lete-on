...
const readyGeneratorKeys = [
  ...
  "sourceGrade6DecimalDivisionE1", "sourceGrade6DecimalDivisionE1Mission3", "sourceGrade6DecimalDivisionE1Mission4", "sourceGrade6DecimalDivisionE2", "sourceGrade6DecimalDivisionE2Example2", "sourceGrade6DecimalDivisionE2Example4", "sourceGrade6DecimalDivisionE2Mission6", "sourceGrade6DecimalDivisionE3", "sourceGrade6DecimalDivisionE4",
...
for (const [generatorKey, expectedCount, label] of [
  ...
  mappedItems.forEach(item => {
    ...
    const readinessItem = (["sourceGrade6DecimalDivisionE1Mission3", "sourceGrade6DecimalDivisionE1Mission4", "sourceGrade6DecimalDivisionE2Example2", "sourceGrade6DecimalDivisionE2Example4", "sourceGrade6DecimalDivisionE2Mission6"].includes(generatorKey) ? readinessU3 : ["sourceGrade6GraphsE1", "sourceGrade6GraphsE2", "sourceGrade6GraphsE3", "sourceGrade6GraphsE4"].includes(generatorKey) ? readinessU5 : ["sourceGrade6VolumeSurfaceE3", "sourceGrade6SurfaceE1", "sourceGrade6VolumeE2", "sourceGrade6VolumeE3Mission3"].includes(generatorKey) ? readinessU6 : readiness).items.find(candidate => candidate.sourceItemId === item.sourceItemId);
    if (["sourceGrade6VolumeSurfaceE3", "sourceGrade6VolumeE3Mission3", "sourceGrade6DecimalDivisionE1Mission3", "sourceGrade6DecimalDivisionE1Mission4", "sourceGrade6DecimalDivisionE2Example2", "sourceGrade6DecimalDivisionE2Example4", "sourceGrade6DecimalDivisionE2Mission6"].includes(generatorKey)) {
