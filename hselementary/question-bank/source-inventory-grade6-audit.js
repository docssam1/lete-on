...
const prismE1VerifiedIds = ["6-1-u2-e1-example-1-1", "6-1-u2-e1-mission-1", "6-1-u2-e1-mission-2", "6-1-u2-e1-mission-5"];
...
prismE1VerifiedIds.forEach(sourceItemId => {
  ...
  const expectedContract = sourceItemId === "6-1-u2-e1-mission-5" ? "two-values" : "single-value";
