(function () {
  ...
  const COPY = {
    ko:{ student:"학생용 · 단원 워크북",teacher:"교사용 · 지도서",unit:"단원 워크북",recheck:"재확인",name:"이름",date:"날짜",class:"반",concept:"개념 학습",practice:"유형 연습",items:"문제",answer:"정답과 검산",teaching:"오답 지도",correct:"맞았습니다.",wrong:"다시 생각해 보세요.",record:"학습 기록 · 답안표",reflection:"내가 만든 통계적 질문",reflectionPrompt:"우리 반에서 조사할 수 있는 통계적 질문을 하나 만들고, 사람마다 어떤 답이 달라질지 쓰세요.",print:"교재 인쇄 · PDF"},
    en:{ student:"Student · Unit Workbook",teacher:"Teacher · Guide",unit:"Unit Workbook",recheck:"Recheck",name:"Name",date:"Date",class:"Class",concept:"Concept Lesson",practice:"Practice",items:"items",answer:"Answer and check",teaching:"Teaching move",correct:"Correct.",wrong:"Think again.",record:"Learning Record · Answer Sheet",reflection:"My Statistical Question",reflectionPrompt:"Write one statistical question about your class. Then state which answer could vary from student to student.",print:"Print Book · PDF"},
    "zh-Hans":{ student:"学生版 · 单元练习册",teacher:"教师版 · 教学指南",unit:"单元练习册",recheck:"复测",name:"姓名",date:"日期",class:"班级",concept:"概念学习",practice:"分类练习",items:"题",answer:"答案与核验",teaching:"教学提示",correct:"正确。",wrong:"请再想一想。",record:"学习记录 · 答题表",reflection:"我提出的统计问题",reflectionPrompt:"提出一个可以在班上调查的统计问题，并说明哪些答案会因学生而不同。",print:"打印练习册 · PDF"}
  };
