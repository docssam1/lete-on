(function (root, factory) {
  const value = typeof module === "object" && module.exports
    ? factory(require("./grade6-rp-clinic-pack.js"), require("./grade6-ns-a-clinic-pack.js"), require("./grade6-ns-b-clinic-pack.js"), require("./grade6-ns-c-clinic-pack.js"))
    : factory(root && root.GFIELDGrade6RPClinicPack, root && root.GFIELDGrade6NSAClinicPack, root && root.GFIELDGrade6NSBClinicPack, root && root.GFIELDGrade6NSCClinicPack);
  if (typeof module === "object" && module.exports) module.exports = value;
  if (root) root.GFIELDGrade6ClinicPacks = value;
})(typeof window !== "undefined" ? window : globalThis, function (ratioPack, fractionPack, computationPack, signedNumberPack) {
  "use strict";
  const packs = [ratioPack, fractionPack, computationPack, signedNumberPack].filter(Boolean);
