(function (root, factory) {
  ...
  const definitions = [
    ...
    {
      clusterId: "6.SP.A",
      titleKo: "평균이 같아도 퍼진 정도는 다를 수 있음을 이해하기",
      conceptExplanationKo: "여러 사람에게 묻거나 여러 번 관찰했을 때 답이 달라질 수 있는 질문은 자료를 모아 답해야 합니다. 미국 6학년 수학에서는 이를 statistical question이라고 합니다. 두 자료의 평균이 같아도 값들이 평균에서 떨어진 정도는 다를 수 있습니다. 평균절대편차는 각 값과 평균 사이 거리의 평균입니다.",
      representation: {
