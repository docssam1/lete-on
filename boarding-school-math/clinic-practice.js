(function () {
  ...
  const COPY = {
    ko: {
      ...
      student: "학생용 · 클리닉", teacher: "교사용 · 공개 예시", workbook: "클리닉 12", recheck: "재확인",
      proofWorkbook: "클리닉 문항", proofRecheck: "재확인", proofStrands: "핵심 영역",
    ...
    en: {
      ...
      student: "STUDENT · CLINIC", teacher: "TEACHER · PUBLIC SAMPLE", workbook: "Clinic 12", recheck: "Recheck",
      proofWorkbook: "Clinic items", proofRecheck: "Recheck", proofStrands: "Strands",
    ...
    "zh-Hans": {
      ...
      student: "学生版 · 专项练习", teacher: "教师版 · 公开示例", workbook: "12题专项练习", recheck: "复测",
      proofWorkbook: "专项练习题", proofRecheck: "复测", proofStrands: "核心领域",
