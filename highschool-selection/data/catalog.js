(function (root) {
  ...
  const exams = [
    ...
    },
    {
      ...
      assetPolicy: "signed-page-images",
      visible: true,
      note: "2024년 4월 원본에서 30문항·문제 8쪽·답안 1쪽·150분을 확인했습니다. 원답 29개는 독립 검산과 일치했고, 공란인 1개는 비공개 검산으로 보완했습니다. 보호 채점기·A4 인쇄 안전본·서명 페이지 자산 검증을 마쳤으며 회차 전체 확인 전에는 학생에게 공개하지 않습니다. 상세 해설은 없고 판본의 20문항 기준도 아직 판정에 사용하지 않습니다."
    },
    {
