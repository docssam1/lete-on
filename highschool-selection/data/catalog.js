(function (root) {
  ...
  const exams = [
    ...
    },
    {
      ...
      assetPolicy: "signed-page-images",
      visible: true,
      note: "2024년 4월 원본에서 30문항·문제 8쪽·답안 1쪽·150분을 확인했습니다. 원답 29개는 독립 검산과 일치했고, 공란인 1개는 비공개 검산으로 보완했습니다. 상세 해설은 없으며, 이 판본의 20문항 기준은 회차 전체 승인 전에는 판정에 사용하지 않습니다. 원본 표지의 과거 운영 문구는 재생성 시험지에서 제거합니다."
    },
    {
