(function (root) {
  ...
  const exams = [
    ...
    },
    {
      ...
      track: "중2-2 편입",
      curriculumVersion: "2022-revised",
      scopeLabel: "중1-1~중2-2 누적 · 원본 회차 대조 중",
      questionCount: null,
      pageCount: null,
      sourceRole: "actual",
      sourceStatus: "candidate_scope_conflict",
      answerStatus: "review_pending",
      classificationStatus: "draft",
      releaseStatus: "blocked",
      assetPolicy: "signed-page-images",
      visible: true,
      note: "지원 과정 범위는 사용자 확인 사항으로 등록했습니다. 현재 찾은 중2-2 표기 후보는 고등 과정 표기와 섞여 있어 이 카드 원본으로 연결하지 않았습니다. 회차·문항 수·답안·배점과 편입 대상 반이 일치하는 원본을 확인하기 전에는 열리지 않습니다."
    },
    {
