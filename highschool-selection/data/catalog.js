(function (root) {
  ...
  const exams = [
    ...
    },
    {
      ...
      privateAnswerPageCount: null,
      sourceRole: "assembled-from-actual",
      deliveryRole: "first-sale-mock",
      formProfile: "sale-mock-a4-v1",
      sourceStatus: "scope_reassembly_required",
      answerStatus: "partial_found",
      classificationStatus: "partial_verified",
      releaseStatus: "blocked",
      assetPolicy: "signed-page-images",
      visible: true,
    ...
    },
    {
      ...
      assetPolicy: "signed-page-images",
      visible: true,
      note: "2024년 5월 원본 판본은 그대로 보존합니다. 새 시험은 중2-1부터 중3-2까지의 실제 원본 문항만 사용합니다. 범위 밖인 원본 8번과 원본이 아닌 대체 29번은 구성에서 빼고, 부족한 두 자리는 같은 범위의 다른 돌파 원본 시험지에서 채운 뒤 다시 검수합니다."
    },
    {
